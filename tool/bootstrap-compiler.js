#!/usr/bin/env node
// generatedy by JSX compiler 0.9.72 (2014-01-16 18:56:32 +0900; f82369af9e74eb683e78096905a5795cdb8c8615)
var JSX = {};
(function (JSX) {
/**
 * extends the class
...
function Util$isNativeClass$LType$(type) {
	...
	if (type instanceof ObjectType) {
		...
		return ! classDef.forEachClassToBase$F$LClassDefinition$B$((function (classDef) {
			if (classDef.className$() === "Object" || (((classDef.flags$() & ClassDefinition.IS_NATIVE) | 0)) === 0) {
				return true;
			}
			return false;
		}));
...
function Util$findFunctionInClass$LClassDefinition$SALType$B(classDef, funcName, argTypes, isStatic) {
	...
	classDef.forEachMemberFunction$F$LMemberFunctionDefinition$B$((function (funcDef) {
		if (isStatic === ((((funcDef.flags$() & ClassDefinition.IS_STATIC) | 0)) !== 0) && funcDef.name$() === funcName && Util$typesAreEqual$ALType$ALType$(funcDef.getArgumentTypes$(), argTypes)) {
			found = funcDef;
			return false;
		}
		return true;
...
function Util$findVariableInClass$LClassDefinition$SB(classDef, name, isStatic) {
	...
	classDef.forEachMemberVariable$F$LMemberVariableDefinition$B$((function (def) {
		if (isStatic === ((((def.flags$() & ClassDefinition.IS_STATIC) | 0)) !== 0) && def.name$() === name) {
			found = def;
			return false;
		}
		return true;
...
function Util$memberRootIsNative$LClassDefinition$SALType$B(classDef, name, argTypes, isStatic) {
	...
	if (isStatic) {
		return (((classDef.flags$() & (((ClassDefinition.IS_NATIVE | ClassDefinition.IS_FAKE) | 0))) | 0)) !== 0;
	}
	function rootIsNativeNonStatic(classDef, name, argTypes) {
		...
		if (found != null && (((found.flags$() & ClassDefinition.IS_OVERRIDE) | 0)) === 0) {
			return (((classDef.flags$() & (((ClassDefinition.IS_NATIVE | ClassDefinition.IS_FAKE) | 0))) | 0)) !== 0;
		}
...
function Util$memberIsExported$LClassDefinition$SALType$B(classDef, name, argTypes, isStatic) {
	...
	if (isStatic) {
		...
		return (((found.flags$() & ClassDefinition.IS_EXPORT) | 0)) !== 0;
	}
	function check(classDef) {
		var found;
		var isExportedInImpl;
		if ((((classDef.flags$() & ClassDefinition.IS_NATIVE) | 0)) !== 0) {
			return false;
		}
		found = Util$findMemberInClass$LClassDefinition$SALType$B(classDef, name, argTypes, false);
		if (found != null && (((found.flags$() & ClassDefinition.IS_EXPORT) | 0)) !== 0) {
			return true;
		}
		if (classDef.extendType$() != null) {
...
function Util$decodeStringLiteral$S(literal) {
	...
	var backslashAt;
	var escapeChar;
	literal = Util$normalizeHeredoc$S(literal);
...
function Util$normalizeHeredoc$S(literal) {
	var body;
	if (! literal.match(/^(?:"""|''')/)) {
		return literal;
	}
...
Util.normalizeHeredoc$S = Util$normalizeHeredoc$S;
		...
		if ((((classDef.flags$() & ClassDefinition.IS_NATIVE) | 0)) === 0) {
			...
			if (ctors.length !== 0) {
				for (j = 0; j < ctors.length; ++j) {
					if ((((ctors[j].flags$() & ClassDefinition.IS_EXPORT) | 0)) !== 0) {
...
function _Util$findFunctions$LClassDefinition$SB(classDef, name, isStatic) {
	...
	for (i = 0; i < members.length; ++i) {
		member = members[i];
		if (member instanceof MemberFunctionDefinition && member.name$() === name && (((member.flags$() & ClassDefinition.IS_STATIC) | 0)) === (isStatic ? ClassDefinition.IS_STATIC : 0)) {
...
_Mangler.prototype.requiresMangling$LMemberFunctionDefinition$ = function (member) {
	return this.requiresMangling$LClassDefinition$SALType$B(member.getClassDef$(), member.name$(), member.getArgumentTypes$(), (((member.flags$() & ClassDefinition.IS_STATIC) | 0)) !== 0);
};
	...
	this._propertyConversionTable = _Minifier$_buildConversionTable$HNL_MinifiedNameGenerator$(this._propertyUseCount, new _MinifiedNameGenerator(_Util$getECMA262ReservedWords$().concat((function () {
		...
		$this._classDefs.forEach((function (classDef) {
			classDef.forEachMember$F$LMemberDefinition$B$((function (member) {
				if ((((member.flags$() & ClassDefinition.IS_STATIC) | 0)) === 0 && ((((((member.flags$() | classDef.flags$()) | 0)) & ClassDefinition.IS_NATIVE) | 0)) !== 0) {
...
_Minifier.prototype._minifyStaticVariables$ = function () {
	...
	this._classDefs.forEach((function (classDef) {
		...
		var stash;
		if ((((classDef.flags$() & (((ClassDefinition.IS_NATIVE | ClassDefinition.IS_FAKE) | 0))) | 0)) === 0) {
			exportedStaticVarNames = [];
			classDef.forEachMemberVariable$F$LMemberVariableDefinition$B$((function (member) {
				if ((((member.flags$() & (((ClassDefinition.IS_STATIC | ClassDefinition.IS_EXPORT) | 0))) | 0)) === (((ClassDefinition.IS_STATIC | ClassDefinition.IS_EXPORT) | 0))) {
...
_StringLiteralExpressionEmitter.prototype.emit$N = function (outerOpPrecedence) {
	var token;
	token = this._expr.getToken$();
	this._emitter._emit$SLToken$(Util$normalizeHeredoc$S(token.getValue$()), token);
};
...
_AsNoConvertExpressionEmitter.prototype.emit$N = function (outerOpPrecedence) {
	...
	if (this._emitter._enableRunTimeTypeCheck) {
		...
		if (srcType.equals$LType$(destType) || srcType.equals$LType$(destType.resolveIfNullable$())) {
			...
			if ((((destClassDef.flags$() & ClassDefinition.IS_FAKE) | 0)) !== 0) {
				...
				return;
			} else if ((((destClassDef.flags$() & (((ClassDefinition.IS_INTERFACE | ClassDefinition.IS_MIXIN) | 0))) | 0)) === 0) {
				emitWithAssertion((function () {
...
_InstanceofExpressionEmitter.prototype.emit$N = function (outerOpPrecedence) {
	...
	} else if ((((expectedType.getClassDef$().flags$() & (((ClassDefinition.IS_INTERFACE | ClassDefinition.IS_MIXIN) | 0))) | 0)) === 0) {
		this.emitWithPrecedence$NNF$V$(outerOpPrecedence, _InstanceofExpressionEmitter._operatorPrecedence, (function () {
			$this._emitter._getExpressionEmitterFor$LExpression$($this._expr.getExpr$()).emit$N(_InstanceofExpressionEmitter._operatorPrecedence);
...
_CallExpressionEmitter.prototype._emitIfJsInvoke$LPropertyExpression$ = function (calleeExpr) {
	...
	if (args[2] instanceof ArrayLiteralExpression) {
		...
		if (args[1] instanceof StringLiteralExpression && _Util$nameIsValidAsProperty$S(Util$decodeStringLiteral$S(args[1].getToken$().getValue$()))) {
			this._emitter._emit$SLToken$(".", calleeExpr.getToken$());
			this._emitter._emit$SLToken$(Util$decodeStringLiteral$S(args[1].getToken$().getValue$()), args[1].getToken$());
		} else {
			this._emitter._emit$SLToken$("[", calleeExpr.getToken$());
...
_NewExpressionEmitter.prototype._emitAsObjectLiteral$LClassDefinition$ALExpression$ = function (classDef, propertyExprs) {
	...
	propertyIndex = 0;
	classDef.forEachMemberVariable$F$LMemberVariableDefinition$B$((function (member) {
		if ((((member.flags$() & ClassDefinition.IS_STATIC) | 0)) === 0) {
			if (propertyIndex !== 0) {
				$this._emitter._emit$SLToken$(", ", $this._expr.getToken$());
			}
...
function JSXCommand$main$LPlatform$AS(platform, args) {
		...
		default:
			...
			if (switchOpt != null) {
				...
				case "cps-transform":
					tasks.push((function (mode) {
						return (function () {
							transformer.setForceTransform$B(mode);
						});
					})(mode));
					break NEXTOPT;
				default:
	...
	compiler.setTransformer$LCodeTransformer$(transformer);
...
TryStatement.prototype.doAnalyze$LAnalysisContext$ = function (context) {
	...
	if ((((context.funcDef.flags$() & ClassDefinition.IS_GENERATOR) | 0)) !== 0) {
...
NewExpression.prototype.analyze$LAnalysisContext$LExpression$ = function (context, parentExpr) {
	...
	if ((((classDef.flags$() & (((ClassDefinition.IS_INTERFACE | ClassDefinition.IS_MIXIN) | 0))) | 0)) !== 0) {
		context.errors.push(new CompileError(this._token, "cannot instantiate an interface or a mixin"));
		return false;
	}
	if ((((classDef.flags$() & ClassDefinition.IS_ABSTRACT) | 0)) !== 0) {
...
SuperExpression.prototype.analyze$LAnalysisContext$LExpression$ = function (context, parentExpr) {
	...
	var funcType;
	var argTypes;
	if ((((context.funcDef.flags$() & ClassDefinition.IS_STATIC) | 0)) !== 0) {
...
PropertyExpression.prototype.assertIsAssignable$LAnalysisContext$LToken$LType$ = function (context, token, type) {
	...
	if ((((varFlags & ClassDefinition.IS_CONST) | 0)) !== 0) {
		context.errors.push(new CompileError(token, "cannot modify a constant"));
		return false;
	} else if ((((varFlags & ClassDefinition.IS_READONLY) | 0)) !== 0) {
...
InstanceofExpression.prototype.analyze$LAnalysisContext$LExpression$ = function (context, parentExpr) {
	...
	if (((this._expectedType.getClassDef$().flags$() & ClassDefinition.IS_FAKE) | 0)) {
...
ThisExpression.prototype.analyze$LAnalysisContext$LExpression$ = function (context, parentExpr) {
	...
	if (rootFuncDef == null || (((rootFuncDef.flags$() & ClassDefinition.IS_STATIC) | 0)) !== 0) {
...
JavaScriptEmitter.prototype._emitCore$ALClassDefinition$ = function (classDefs) {
	...
	for (i = 0; i < classDefs.length; ++i) {
		...
		classDefs[i].forEachMemberVariable$F$LMemberVariableDefinition$B$((function (varDef) {
			if ((((varDef.flags$() & ClassDefinition.IS_STATIC) | 0)) !== 0 && varDef.getInitialValue$() != null) {
	...
	try {
		...
		for (i = 0; i < members.length; ++i) {
			...
			if (member instanceof MemberFunctionDefinition) {
				if (! (member.name$() === "constructor" && (((member.flags$() & ClassDefinition.IS_STATIC) | 0)) === 0) && member.getStatements$() != null) {
...
JavaScriptEmitter.prototype._emitStaticInitializationCode$LClassDefinition$ = function (classDef) {
	...
	for (i = 0; i < members.length; ++i) {
		member = members[i];
		if (member instanceof MemberVariableDefinition && (((member.flags$() & (((ClassDefinition.IS_STATIC | ClassDefinition.IS_NATIVE) | 0))) | 0)) === ClassDefinition.IS_STATIC) {
...
JavaScriptEmitter.prototype._emitClassMap$ALClassDefinition$ = function (classDefs) {
	...
	for (i = 0; i < classDefs.length; ) {
		if (classDefs[i].getToken$() == null || (((classDefs[i].flags$() & ClassDefinition.IS_NATIVE) | 0)) !== 0) {
	...
	while (classDefs.length !== 0) {
		...
		pushClass = (function (classDef) {
			...
			var push;
			ctors = _Util$findFunctions$LClassDefinition$SB(classDef, "constructor", false);
			if ((((classDef.flags$() & ClassDefinition.IS_EXPORT) | 0)) !== 0) {
				if (ctors.length !== 0) {
					exportedCtor = null;
					for (i = 0; i < ctors.length; ++i) {
						if ((((ctors[i].flags$() & ClassDefinition.IS_EXPORT) | 0)) !== 0) {
	...
	if (implementTypes.length !== 0) {
		...
		(function buildUnresolvedExports(baseClassDef) {
			...
			baseClassDef.forEachMemberFunction$F$LMemberFunctionDefinition$B$((function (funcDef) {
				if ((((funcDef.flags$() & (((ClassDefinition.IS_STATIC | ClassDefinition.IS_EXPORT) | 0))) | 0)) === ClassDefinition.IS_EXPORT && funcDef.name$() !== "constructor") {
...
JavaScriptEmitter.prototype._emitFunction$LMemberFunctionDefinition$ = function (funcDef) {
	var $this = this;
	var isStatic;
	isStatic = (((funcDef.flags$() & ClassDefinition.IS_STATIC) | 0)) !== 0;
	if (isStatic) {
...
JavaScriptEmitter.prototype._emitFunctionBody$LMemberFunctionDefinition$ = function (funcDef) {
	...
	try {
		...
		if (funcDef.getParent$() == null && (((funcDef.flags$() & ClassDefinition.IS_STATIC) | 0)) === 0 && funcDef.getClosures$().length !== 0) {
...
function LocalVariable$0(name, type) {
	LocalVariable.call(this, name, type, false);
};

$__jsx_extend([LocalVariable, LocalVariable$0], Object);
...
LocalVariable.prototype._instantiate$LInstantiationContext$ = function (instantiationContext) {
	...
	return new LocalVariable$0(this._name, type);
};


function CaughtVariable(name, type) {
	LocalVariable$0.call(this, name, type);
};
	...
	function pushMatchingMember(classDef) {
		...
		if (mode !== ClassDefinition.GET_MEMBER_MODE_SUPER) {
			for (i = 0; i < classDef._members.length; ++i) {
				...
				if ((((member.flags$() & ClassDefinition.IS_DELETE) | 0)) !== 0) {
				} else if (((((member.flags$() & ClassDefinition.IS_STATIC) | 0)) !== 0) === isStatic && name === member.name$()) {
					if (member instanceof MemberVariableDefinition) {
						if ((((member.flags$() & ClassDefinition.IS_OVERRIDE) | 0)) === 0) {
							type = member.getType$();
						...
						if (member instanceof InstantiatedMemberFunctionDefinition) {
							...
							if (member.getStatements$() != null || mode !== ClassDefinition.GET_MEMBER_MODE_FUNCTION_WITH_BODY || (((member.flags$() & (((ClassDefinition.IS_NATIVE | ClassDefinition.IS_ABSTRACT) | 0))) | 0)) === ClassDefinition.IS_NATIVE) {
...
ClassDefinition.prototype.normalizeClassDefs$ALCompileError$ = function (errors) {
	...
	for (x = 0; x < this._members.length; ++x) {
		for (y = 0; y < x; ++y) {
			if (this._members[x].name$() === this._members[y].name$() && (((this._members[x].flags$() & ClassDefinition.IS_STATIC) | 0)) === (((this._members[y].flags$() & ClassDefinition.IS_STATIC) | 0))) {
				errorMsg = null;
				if (this._members[x] instanceof MemberFunctionDefinition && this._members[y] instanceof MemberFunctionDefinition) {
					if (Util$typesAreEqual$ALType$ALType$(this._members[x].getArgumentTypes$(), this._members[y].getArgumentTypes$())) {
						errorMsg = "a " + ((((this._members[x].flags$() & ClassDefinition.IS_STATIC) | 0)) !== 0 ? "static" : "member") + " function with same name and arguments is already defined";
...
ClassDefinition.prototype.resolveTypes$LAnalysisContext$ = function (context) {
	...
	for (i = 0; i < this._implementTypes.length; ++i) {
		...
		if (baseClass != null) {
			if ((((baseClass.flags$() & (((ClassDefinition.IS_INTERFACE | ClassDefinition.IS_MIXIN) | 0))) | 0)) === 0) {
	...
	if (this.forEachMemberFunction$F$LMemberFunctionDefinition$B$((function (funcDef) {
		...
		isNative = (((this.flags$() & ClassDefinition.IS_NATIVE) | 0)) !== 0;
		func = new MemberFunctionDefinition(this._token, new Token$2("constructor", true), ((ClassDefinition.IS_FINAL | ((this.flags$() & (((ClassDefinition.IS_NATIVE | ClassDefinition.IS_EXPORT) | 0))) | 0)) | 0), Type.voidType, [], isNative ? null : [], isNative ? null : [], [], this._token, null);
		func.setClassDef$LClassDefinition$(this);
		this._members.push(func);
	}
	for (i = 0; i !== this._members.length; ++i) {
		if (this._members[i] instanceof MemberFunctionDefinition && this._members[i].name$() === "constructor" && (((this._members[i].flags$() & (((ClassDefinition.IS_STATIC | ClassDefinition.IS_DELETE) | 0))) | 0)) === ClassDefinition.IS_DELETE) {
...
ClassDefinition.prototype._analyzeClassDef$LAnalysisContext$ = function (context) {
	...
	if ((((this.flags$() & (((ClassDefinition.IS_INTERFACE | ClassDefinition.IS_MIXIN) | 0))) | 0)) === 0) {
		if (this._baseClassDef != null) {
			if ((((this._baseClassDef.flags$() & ClassDefinition.IS_FINAL) | 0)) !== 0) {
				context.errors.push(new CompileError(this.getToken$(), "cannot extend final class '" + this._baseClassDef.classFullName$() + "'"));
				return;
			}
			if ((((this._baseClassDef.flags$() & (((ClassDefinition.IS_INTERFACE | ClassDefinition.IS_MIXIN) | 0))) | 0)) !== 0) {
		...
		for (i = 0; i < implementClassDefs.length; ++i) {
			if ((((implementClassDefs[i].flags$() & (((ClassDefinition.IS_INTERFACE | ClassDefinition.IS_MIXIN) | 0))) | 0)) === 0) {
	...
	if (! this.forEachClassToBase$F$LClassDefinition$B$((function (classDef) {
		if ((((classDef.flags$() & ClassDefinition.IS_MIXIN) | 0)) !== 0) {
	...
	if ((((this._flags & (((ClassDefinition.IS_INTERFACE | ClassDefinition.IS_MIXIN) | 0))) | 0)) === 0) {
		for (i = 0; i < this._members.length; ++i) {
			if (this._members[i] instanceof MemberFunctionDefinition && (((this._members[i].flags$() & ClassDefinition.IS_OVERRIDE) | 0)) !== 0) {
		...
		for (i = 0; i < this._implementTypes.length; ++i) {
			if ((((this._implementTypes[i].getClassDef$().flags$() & ClassDefinition.IS_MIXIN) | 0)) === 0) {
				continue;
			}
	...
	if ((((this._flags & (((((ClassDefinition.IS_ABSTRACT | ClassDefinition.IS_INTERFACE) | 0) | ClassDefinition.IS_MIXIN) | 0))) | 0)) === 0) {
		abstractMembers = [];
		this.forEachClassToBase$F$LClassDefinition$B$((function (classDef) {
			return classDef.forEachMember$F$LMemberDefinition$B$((function (member) {
				var i;
				if ((((member.flags$() & ClassDefinition.IS_ABSTRACT) | 0)) !== 0) {
	...
	this._getMembers$ALMemberDefinition$F$LMemberDefinition$B$([  ], (function (member) {
		...
		if ((((member.flags$() & (((ClassDefinition.IS_STATIC | ClassDefinition.IS_EXPORT) | 0))) | 0)) !== ClassDefinition.IS_EXPORT) {
			return false;
		}
		...
		if (((($this._flags & ClassDefinition.IS_EXPORT) | 0)) !== 0 && member.name$() === "constructor") {
...
ClassDefinition.prototype._assertMemberIsDefinable$LAnalysisContext$LMemberDefinition$LClassDefinition$LToken$ = function (context, member, memberClassDef, token) {
	...
	if (member instanceof MemberVariableDefinition) {
		...
		isCheckingInterface = (((memberClassDef.flags$() & ClassDefinition.IS_INTERFACE) | 0)) !== 0;
...
ClassDefinition.prototype._assertMemberVariableIsDefinable$LAnalysisContext$LMemberVariableDefinition$LClassDefinition$LToken$ = function (context, member, memberClassDef, token) {
	...
	for (i = 0; i < this._members.length; ++i) {
		if (this._members[i].name$() === member.name$()) {
			if ((((this._members[i].flags$() & ClassDefinition.IS_ABSTRACT) | 0)) === 0) {
...
ClassDefinition.prototype._assertMemberFunctionIsDefinable$LAnalysisContext$LMemberFunctionDefinition$LClassDefinition$LToken$BB = function (context, member, memberClassDef, token, reportOverridesAsWell, isCheckingInterface) {
	...
	for (i = 0; i < this._members.length; ++i) {
		...
		if (! isCheckingInterface && ((((((member.flags$() | this._members[i].flags$()) | 0)) & ClassDefinition.IS_STATIC) | 0)) === 0 && (((member.flags$() & ClassDefinition.IS_OVERRIDE) | 0)) === 0) {
		...
		if (reportOverridesAsWell && (((this._members[i].flags$() & ClassDefinition.IS_OVERRIDE) | 0)) !== 0) {
...
ClassDefinition.prototype._assertFunctionIsOverridable$LAnalysisContext$LMemberFunctionDefinition$ = function (context, overrideDef) {
	...
	for (i = 0; i < this._members.length; ++i) {
		if (this._members[i].name$() === overrideDef.name$() && this._members[i] instanceof MemberFunctionDefinition && (((this._members[i].flags$() & ClassDefinition.IS_STATIC) | 0)) === 0 && Util$typesAreEqual$ALType$ALType$(this._members[i].getArgumentTypes$(), overrideDef.getArgumentTypes$())) {
			if ((((this._members[i].flags$() & ClassDefinition.IS_FINAL) | 0)) !== 0) {
...
ClassDefinition.prototype._getMembers$ALMemberDefinition$BNN = function (list, functionOnly, flagsMask, flagsMaskMatch) {
	...
	this._getMembers$ALMemberDefinition$F$LMemberDefinition$B$(list, (function (member) {
		...
		if ((((member.flags$() & flagsMask) | 0)) !== flagsMaskMatch) {
			return false;
		}
...
ClassDefinition.prototype.hasDefaultConstructor$ = function () {
	...
	for (i = 0; i < this._members.length; ++i) {
		member = this._members[i];
		if (member.name$() === "constructor" && (((member.flags$() & ClassDefinition.IS_STATIC) | 0)) === 0 && member instanceof MemberFunctionDefinition) {
...
MemberVariableDefinition.prototype.analyze$LAnalysisContext$ = function (context) {
	var rhs;
	if (this.getInitialValue$() == null && (((this.getClassDef$().flags$() & ClassDefinition.IS_NATIVE) | 0)) !== ClassDefinition.IS_NATIVE) {
...
MemberVariableDefinition.prototype.getNotation$ = function () {
	...
	s += ((((this.flags$() & ClassDefinition.IS_STATIC) | 0)) !== 0 ? "." : "#");
	s += this.name$();
	return s;
};
...
MemberFunctionDefinition.prototype.isGenerator$ = function () {
	return (((this._flags & ClassDefinition.IS_GENERATOR) | 0)) !== 0;
};
	...
	function cloneFuncDef(funcDef) {
		...
		if (funcLocal != null) {
			if ((newFuncLocal = getStash(funcLocal).newLocal) != null) {
				...
				newFuncLocal = new LocalVariable$0(funcLocal.getName$(), funcLocal.getType$());
		...
		locals = funcDef.getLocals$().map((function (local) {
			...
			newLocal = new LocalVariable$0(local.getName$(), local.getType$());
...
MemberFunctionDefinition.prototype.analyze$LAnalysisContext$ = function (outerContext) {
	...
	this._analyzed = true;
	if ((((this.flags$() & ClassDefinition.IS_GENERATED) | 0)) === 0) {
...
MemberFunctionDefinition.prototype.generateWrappersForDefaultParameters$ = function () {
	...
	for (; origArgIndex !== this.getArguments$().length; ++origArgIndex) {
		...
		if (this.name$() === "constructor") {
			...
			invocant = ((((this.flags$() & ClassDefinition.IS_STATIC) | 0)) === 0 ? new ThisExpression(new Token$2("this", false), this.getClassDef$()) : new ClassExpression(new Token$2(this.getClassDef$().className$(), true), createObjectType(this.getClassDef$())));
		...
		if (! (this instanceof TemplateFunctionDefinition)) {
			wrapper = new MemberFunctionDefinition(this.getToken$(), this.getNameToken$(), ((((this.flags$() | ClassDefinition.IS_INLINE) | 0) | ClassDefinition.IS_GENERATED) | 0), this.getReturnType$(), formalArgs, [], [ statement ], this.getClosures$().slice(0), this._lastTokenOfBody, this._docComment);
		} else {
...
MemberFunctionDefinition.prototype._fixupConstructor$LAnalysisContext$ = function (context) {
	...
	success = true;
	isAlternate = false;
	if ((((this._flags & ClassDefinition.IS_GENERATOR) | 0)) !== 0) {
	...
	this._classDef.forEachMemberVariable$F$LMemberVariableDefinition$B$((function (member) {
		if ((((member.flags$() & (((ClassDefinition.IS_STATIC | ClassDefinition.IS_ABSTRACT) | 0))) | 0)) === 0) {
...
MemberFunctionDefinition.prototype.getType$ = function () {
	return ((((this._flags & ClassDefinition.IS_STATIC) | 0)) !== 0 ? new StaticFunctionType(this._token, this._returnType, this.getArgumentTypes$(), false) : new MemberFunctionType(this._token, new ObjectType(this._classDef), this._returnType, this.getArgumentTypes$(), false));
};
...
TemplateFunctionType.prototype._deduceByArgumentTypes$LToken$ALType$BBALCompileNote$ = function (token, argTypes, isStatic, exact, notes) {
	...
	var i;
	errors = [];
	if (((((this._funcDef.flags$() & ClassDefinition.IS_STATIC) | 0)) === ClassDefinition.IS_STATIC) !== isStatic) {
		if (isStatic) {
			notes.push(new CompileNote(token, 'candidate function not viable: expected a static function, but got a member function'));
		} else {
			notes.push(new CompileNote(token, 'candidate function not viable: expected a member function, but got a static function'));
...
TemplateFunctionType.prototype._getExpectedTypes$ALUtil$x2EArgumentTypeRequest$NB = function (expected, numberOfArgs, isStatic) {
	...
	var hasCallback;
	var callbackArgTypes;
	if (((((this._funcDef.flags$() & ClassDefinition.IS_STATIC) | 0)) !== 0) !== isStatic) {
		return;
	}
	argTypes = [];
	if (this._argTypes.length > 0 && numberOfArgs >= this._argTypes.length && this._argTypes[this._argTypes.length - 1] instanceof VariableLengthArgumentType) {
...
Parser.prototype._classDefinition$ = function () {
	...
	this._classFlags = 0;
	if (this._outerClass) {
		this._classFlags |= ((this._outerClass.classFlags & ClassDefinition.IS_NATIVE) | 0);
	}
	nativeSource = null;
	docComment = null;
	while (true) {
		...
		if (token.getValue$() === "class") {
			...
			if ((((this._classFlags & (((ClassDefinition.IS_FINAL | ClassDefinition.IS_NATIVE) | 0))) | 0)) !== 0) {
			...
			if ((((this._classFlags & (((((ClassDefinition.IS_FINAL | ClassDefinition.IS_NATIVE) | 0) | ClassDefinition.IS_EXPORT) | 0))) | 0)) !== 0) {
		...
		if ((((this._classFlags & newFlag) | 0)) !== 0) {
	...
	if ((((this._classFlags & (((ClassDefinition.IS_INTERFACE | ClassDefinition.IS_MIXIN) | 0))) | 0)) === 0) {
		if (this._expectOpt$S("extends") != null) {
			this._extendType = this._objectTypeDeclaration$LToken$BF$LClassDefinition$B$(null, true, (function (classDef) {
				return (((classDef.flags$() & (((((ClassDefinition.IS_MIXIN | ClassDefinition.IS_INTERFACE) | 0) | ClassDefinition.IS_FINAL) | 0))) | 0)) === 0;
			}));
		}
	...
	} else if ((((this._classFlags & (((((ClassDefinition.IS_ABSTRACT | ClassDefinition.IS_FINAL) | 0) | ClassDefinition.IS_NATIVE) | 0))) | 0)) !== 0) {
		this._newError$S("interface or mixin cannot have attributes: 'abstract', 'final', 'native");
		this._classFlags &= ~ (((((ClassDefinition.IS_ABSTRACT | ClassDefinition.IS_FINAL) | 0) | ClassDefinition.IS_NATIVE) | 0));
	}
	if (this._expectOpt$S("implements") != null) {
		do {
			implementType = this._objectTypeDeclaration$LToken$BF$LClassDefinition$B$(null, true, (function (classDef) {
				return (((classDef.flags$() & (((ClassDefinition.IS_MIXIN | ClassDefinition.IS_INTERFACE) | 0))) | 0)) !== 0;
			}));
	...
	if (assignToken != null) {
		...
		if ((((this._classFlags & ClassDefinition.IS_NATIVE) | 0)) === 0) {
			this._errors.push(new CompileError(assignToken, "in-line native definition requires native attribute"));
			return null;
		}
	}
	if ((((this._classFlags & ClassDefinition.IS_NATIVE) | 0)) === 0 && Util$isBuiltInClass$S(className.getValue$())) {
...
Parser.prototype._memberDefinition$ = function () {
	...
	while (true) {
		...
		if (token.getValue$() === "const") {
			if ((((flags & ClassDefinition.IS_STATIC) | 0)) === 0) {
			...
			if (isNoExport) {
				this._newError$S("same attribute cannot be specified more than once");
				return null;
			} else if ((((flags & ClassDefinition.IS_EXPORT) | 0)) !== 0) {
			...
			case "abstract":
				...
				break;
			case "override":
				if ((((this._classFlags & ClassDefinition.IS_INTERFACE) | 0)) !== 0) {
	...
	function shouldExport(name) {
		...
		if (((($this._classFlags & ClassDefinition.IS_EXPORT) | 0)) === 0) {
			return false;
		}
		if (name.charAt(0) === "_") {
			return false;
	...
	if ((((flags & ~ (((((((((ClassDefinition.IS_STATIC | ClassDefinition.IS_ABSTRACT) | 0) | ClassDefinition.IS_CONST) | 0) | ClassDefinition.IS_READONLY) | 0) | ClassDefinition.IS_EXPORT) | 0))) | 0)) !== 0) {
		this._newError$S("variables may only have attributes: static, abstract, const");
		return null;
	}
	if ((((flags & ClassDefinition.IS_READONLY) | 0)) !== 0 && (((this._classFlags & ClassDefinition.IS_NATIVE) | 0)) === 0) {
	...
	closures = [];
	if (this._expectOpt$S("=") != null) {
		if ((((flags & ClassDefinition.IS_ABSTRACT) | 0)) !== 0) {
	...
	if (this._typeArgs.length === 0 && initialValue == null && (((this._classFlags & ClassDefinition.IS_NATIVE) | 0)) === 0) {
...
Parser.prototype._functionDefinition$LToken$NLDocComment$F$SB$ = function (token, flags, docComment, shouldExport) {
	...
	if (name.getValue$() === "constructor") {
		...
		if ((((flags & (((ClassDefinition.IS_ABSTRACT | ClassDefinition.IS_FINAL) | 0))) | 0)) !== 0) {
			this._newError$S("constructor cannot be declared as 'abstract' or 'final'");
			return null;
		}
		flags |= ClassDefinition.IS_FINAL;
	}
	flags |= ((this._classFlags & (((ClassDefinition.IS_NATIVE | ClassDefinition.IS_FINAL) | 0))) | 0);
	...
	try {
		...
		args = this._functionArgumentsExpr$BBB((((this._classFlags & ClassDefinition.IS_NATIVE) | 0)) !== 0, true, true);
		if (args == null) {
			return null;
		}
		returnType = null;
		...
		if ((((flags & ClassDefinition.IS_DELETE) | 0)) !== 0) {
			if (name.getValue$() !== "constructor" || (((flags & ClassDefinition.IS_STATIC) | 0)) !== 0) {
		...
		} else if ((((flags & (((((ClassDefinition.IS_ABSTRACT | ClassDefinition.IS_NATIVE) | 0) | ClassDefinition.IS_DELETE) | 0))) | 0)) !== 0) {
...
Parser.prototype._functionExpr$LToken$ = function (token) {
	...
	funcLocal = null;
	if (name != null) {
		funcLocal = new LocalVariable$0(name, type);
	}
	funcDef = this._functionBody$LToken$LToken$LLocalVariable$ALArgumentDeclaration$LType$B(token, name, funcLocal, args, returnType, true);
	if (funcDef == null) {
		return null;
...
function _Util$0$exprHasSideEffects$LExpression$(expr) {
	return ! (function onExpr(expr) {
		...
		if (_Util$0$exprIsAssignment$LExpression$(expr) || expr instanceof NewExpression || expr instanceof SuperExpression) {
			...
			if (callingFuncDef != null && (((callingFuncDef.flags$() & ClassDefinition.IS_PURE) | 0)) !== 0) {
			} else {
				return false;
			}
		} else if (expr instanceof PropertyExpression) {
...
function _Util$0$exprIsIndependent$LExpression$(expr) {
	return (function onExpr(expr) {
		if (expr instanceof LocalExpression) {
			return false;
		} else if (expr instanceof FunctionExpression) {
...
_Util$0.exprIsIndependent$LExpression$ = _Util$0$exprIsIndependent$LExpression$;
...
_OptimizeCommand.prototype.createVar$LMemberFunctionDefinition$LType$S = function (funcDef, type, baseName) {
	...
	newLocal = new LocalVariable$0(new Token$2(baseName + "$" + (i + ""), false), type);
...
_LinkTimeOptimizationCommand.prototype.performOptimization$ = function () {
	...
	this.getCompiler$().forEachClassDef$F$LParser$LClassDefinition$B$((function (parser, classDef) {
		if ((((classDef.flags$() & (((((((((ClassDefinition.IS_INTERFACE | ClassDefinition.IS_MIXIN) | 0) | ClassDefinition.IS_NATIVE) | 0) | ClassDefinition.IS_FINAL) | 0) | ClassDefinition.IS_EXPORT) | 0))) | 0)) === 0 && $this.getStash$LStashable$(classDef).extendedBy.length === 0) {
			$this.log$S("marking class as final: " + classDef.className$());
			classDef.setFlags$N(((classDef.flags$() | ClassDefinition.IS_FINAL) | 0));
			classDef.forEachMemberFunction$F$LMemberFunctionDefinition$B$((function (funcDef) {
				if ((((funcDef.flags$() & (((ClassDefinition.IS_STATIC | ClassDefinition.IS_FINAL) | 0))) | 0)) === 0) {
					funcDef.setFlags$N(((funcDef.flags$() | ClassDefinition.IS_FINAL) | 0));
				}
				return true;
			}));
		} else if ((((classDef.flags$() & (((ClassDefinition.IS_NATIVE | ClassDefinition.IS_FINAL) | 0))) | 0)) === 0) {
			classDef.forEachMemberFunction$F$LMemberFunctionDefinition$B$((function (funcDef) {
				var overrides;
				if ((((funcDef.flags$() & (((((ClassDefinition.IS_STATIC | ClassDefinition.IS_NATIVE) | 0) | ClassDefinition.IS_FINAL) | 0))) | 0)) !== 0) {
				} else if ((((funcDef.flags$() & ClassDefinition.IS_ABSTRACT) | 0)) === 0) {
					if (funcDef.getStatements$() == null) {
...
_LinkTimeOptimizationCommand.prototype._getOverridesByClass$LClassDefinition$LClassDefinition$SALType$ = function (srcClassDef, classDef, name, argTypes) {
	...
	function addOverride(funcDef) {
		if (funcDef.name$() === name && (((funcDef.flags$() & ClassDefinition.IS_ABSTRACT) | 0)) === 0 && Util$typesAreEqual$ALType$ALType$(funcDef.getArgumentTypes$(), argTypes)) {
...
_StripOptimizeCommand.prototype._touchInstance$LClassDefinition$ = function (classDef) {
	...
	classDef.forEachMemberVariable$F$LMemberVariableDefinition$B$((function (varDef) {
		if ((((varDef.flags$() & ClassDefinition.IS_STATIC) | 0)) === 0) {
...
_StripOptimizeCommand.prototype.performOptimization$ = function () {
	...
	this.getCompiler$().forEachClassDef$F$LParser$LClassDefinition$B$((function (parser, classDef) {
		if (! (classDef instanceof TemplateClassDefinition) && (((classDef.flags$() & ClassDefinition.IS_NATIVE) | 0)) !== 0) {
			classDef.forEachMemberFunction$F$LMemberFunctionDefinition$B$((function (funcDef) {
				if (funcDef.name$() === "constructor") {
				} else if ((((funcDef.flags$() & ClassDefinition.IS_FINAL) | 0)) !== 0) {
				} else {
	...
	this.getCompiler$().forEachClassDef$F$LParser$LClassDefinition$B$((function (parser, classDef) {
		if (isEmittedClass(classDef)) {
			...
			classDef.forEachMember$F$LMemberDefinition$B$((function (member) {
				var funcDef;
				if ((((member.flags$() & ClassDefinition.IS_EXPORT) | 0)) !== 0) {
					if ((((member.flags$() & ClassDefinition.IS_STATIC) | 0)) !== 0) {
		...
		if (isEmittedClass(classDef)) {
			...
			for (memberIndex = 0; memberIndex !== members.length; ) {
				...
				if (memberShouldPreserve(member)) {
					if (member instanceof MemberFunctionDefinition && (((member.flags$() & ClassDefinition.IS_STATIC) | 0)) === 0 && member.name$() === "constructor") {
						++numConstructors;
					}
					++memberIndex;
			...
			if (numConstructors === 0) {
				...
				ctor = new MemberFunctionDefinition(null, new Token$2("constructor", true), ((ClassDefinition.IS_FINAL | ((classDef.flags$() & ClassDefinition.IS_EXPORT) | 0)) | 0), Type.voidType, [], [], [], [], classDef.getToken$(), null);
	...
	this.getCompiler$().getParsers$().forEach((function (parser) {
		...
		for (i = 0; i !== classDefs.length; ) {
			preserve = true;
			if ((((classDefs[i].flags$() & ClassDefinition.IS_NATIVE) | 0)) !== 0 && classDefs[i].getNativeSource$() != null && ! $this.getStash$LStashable$(classDefs[i]).touched && classDefs[i].forEachMember$F$LMemberDefinition$B$((function (member) {
				if ((((member.flags$() & ClassDefinition.IS_STATIC) | 0)) === 0) {
					return true;
				}
	...
	function onExpr(expr) {
		...
		if (expr instanceof NewExpression) {
			...
			if (propertyExpr.isClassSpecifier$()) {
				if ((((holderClassDef.flags$() & ClassDefinition.IS_NATIVE) | 0)) !== 0) {
...
function _DetermineCalleeCommand$findCallingFunctionInClass$LClassDefinition$SALType$B(classDef, funcName, argTypes, isStatic) {
	...
	if (found != null) {
		if ((((found.flags$() & (((ClassDefinition.IS_STATIC | ClassDefinition.IS_FINAL) | 0))) | 0)) === 0) {
			found = null;
		}
	}
	return found;
...
_StaticizeOptimizeCommand.prototype.performOptimization$ = function () {
	...
	function memberCanBeStaticized(funcDef) {
		var onStatement;
		if ((((funcDef.flags$() & (((((((((ClassDefinition.IS_OVERRIDE | ClassDefinition.IS_ABSTRACT) | 0) | ClassDefinition.IS_FINAL) | 0) | ClassDefinition.IS_STATIC) | 0) | ClassDefinition.IS_NATIVE) | 0))) | 0)) !== ClassDefinition.IS_FINAL) {
			return false;
		}
		if (funcDef.name$() === "constructor") {
			return false;
...
_StaticizeOptimizeCommand.prototype._staticizeMethod$LMemberFunctionDefinition$ = function (funcDef) {
	...
	staticFuncDef.setFlags$N(((((funcDef.flags$() & ~ ClassDefinition.IS_EXPORT) | 0) | ClassDefinition.IS_STATIC) | 0));
	...
	function onExpr(expr, replaceCb) {
		...
		if (expr instanceof CallExpression) {
			...
			if (calleeExpr instanceof PropertyExpression && ! calleeExpr.getExpr$().isClassSpecifier$() && ! calleeExpr.getType$().isAssignable$()) {
				...
				if ((((receiverType.getClassDef$().flags$() & (((ClassDefinition.IS_INTERFACE | ClassDefinition.IS_MIXIN) | 0))) | 0)) === 0) {
			...
			if (funcDef != null && (newName = $this.getStash$LStashable$(funcDef).altName) != null) {
				...
				if ((((rewritingFuncDef.flags$() & ClassDefinition.IS_STATIC) | 0)) !== 0) {
...
_UnclassifyOptimizationCommand.prototype.performOptimization$ = function () {
	...
	classDefs.forEach((function (classDef) {
		...
		classDef.forEachMemberFunction$F$LMemberFunctionDefinition$B$((function onFunction(funcDef) {
			if ((((funcDef.flags$() & ClassDefinition.IS_STATIC) | 0)) === 0 && funcDef.name$() !== "constructor") {
...
_UnclassifyOptimizationCommand.prototype._getClassesToUnclassify$ = function () {
	...
	candidates = [];
	this.getCompiler$().forEachClassDef$F$LParser$LClassDefinition$B$((function (parser, classDef) {
		if ((((classDef.flags$() & (((((ClassDefinition.IS_FINAL | ClassDefinition.IS_NATIVE) | 0) | ClassDefinition.IS_EXPORT) | 0))) | 0)) === ClassDefinition.IS_FINAL && classDef.extendType$().getClassDef$().className$() === "Object" && classDef.implementTypes$().length === 0 && classDef.forEachMemberFunction$F$LMemberFunctionDefinition$B$((function (funcDef) {
			return (((funcDef.flags$() & (((ClassDefinition.IS_OVERRIDE | ClassDefinition.IS_EXPORT) | 0))) | 0)) === 0;
		}))) {
	...
	this.getCompiler$().forEachClassDef$F$LParser$LClassDefinition$B$((function (parser, classDef) {
		...
		function onExpr(expr) {
			...
			if (! (expr != null)) {
				debugger;
				throw new Error("[src/optimizer.jsx:1471:28] assertion failure\n                assert expr != null;\n                            ^^\n");
			}
...
_UnclassifyOptimizationCommand.prototype._rewriteFunctionAsStatic$LMemberFunctionDefinition$ = function (funcDef) {
	...
	funcDef.setFlags$N(((funcDef.flags$() | ClassDefinition.IS_STATIC) | 0));
};
...
_FoldConstantCommand.prototype._optimizeExpression$LExpression$F$LExpression$V$ = function (expr, replaceCb) {
	...
	if (expr instanceof PropertyExpression) {
		...
		if (propertyExpr.getExpr$().isClassSpecifier$()) {
			...
			if (member != null && (((member.flags$() & ClassDefinition.IS_CONST) | 0)) !== 0) {
				...
				if (foldedExpr != null) {
					...
					if (foldedExpr != null && ! (foldedExpr instanceof StringLiteralExpression && Util$decodeStringLiteral$S(foldedExpr.getToken$().getValue$()).length > _FoldConstantCommand.LONG_STRING_LITERAL)) {
			...
			if (propertyExpr.getIdentifierToken$().getValue$() === "length") {
				replaceCb(new NumberLiteralExpression(new Token$3(Util$decodeStringLiteral$S(propertyExpr.getExpr$().getToken$().getValue$()).length + "")));
			}
		}
	} else if (expr instanceof SignExpression) {
		...
		if (baseExpr instanceof IntegerLiteralExpression) {
			...
			replaceCb(new IntegerLiteralExpression(new Token$3(calculateCb(exprAsNumber(baseExpr)) + "")));
		} else if (baseExpr instanceof NumberLiteralExpression) {
			this.log$S("folding operator (number) " + expr.getToken$().getNotation$());
			replaceCb(new NumberLiteralExpression(new Token$3(calculateCb(exprAsNumber(baseExpr)) + "")));
		}
	} else if (expr instanceof BitwiseNotExpression) {
		baseExpr = expr.getExpr$();
		if (this._isIntegerOrNumberLiteralExpression$LExpression$(baseExpr)) {
			this.log$S("folding operator " + expr.getToken$().getNotation$());
			replaceCb(new IntegerLiteralExpression(new Token$3(~ exprAsNumber(baseExpr) + "")));
		}
	} else if (expr instanceof AdditiveExpression) {
		...
		if (this._foldNumericBinaryExpression$LBinaryExpression$F$LExpression$V$(expr, replaceCb)) {
			...
			replaceCb(new StringLiteralExpression(new Token$2(Util$encodeStringLiteral$S(Util$decodeStringLiteral$S(firstExpr.getToken$().getValue$()) + Util$decodeStringLiteral$S(secondExpr.getToken$().getValue$())), false)));
		}
	} else if (expr instanceof EqualityExpression) {
...
_FoldConstantCommand.prototype._foldCallExpression$LCallExpression$F$LExpression$V$ = function (callExpr, replaceCb) {
	...
	holderType = propertyExpr.getHolderType$();
	if ((((holderType.getClassDef$().flags$() & ClassDefinition.IS_NATIVE) | 0)) === 0) {
		return;
	}
	function argAsNumber(index) {
		return +callExpr.getArguments$()[index].getToken$().getValue$();
	}
	member = null;
	...
	if (member != null && (((member.flags$() & ClassDefinition.IS_PURE) | 0)) === 0) {
		return;
	}
	if (propertyExpr.getExpr$().isClassSpecifier$()) {
		if (holderType.getClassDef$().classFullName$() === "Math") {
			...
			case "sqrt":
				...
				replaceCb(new NumberLiteralExpression(new Token$3(Math.sqrt(argAsNumber(0)) + "")));
				break;
			case "log":
				this.log$S("folding " + member.getNotation$());
				replaceCb(new NumberLiteralExpression(new Token$3(Math.log(argAsNumber(0)) + "")));
				break;
			case "pow":
				this.log$S("folding " + member.getNotation$());
				replaceCb(new NumberLiteralExpression(new Token$3(Math.pow(argAsNumber(0), argAsNumber(1)) + "")));
				break;
			case "sin":
				this.log$S("folding " + member.getNotation$());
				replaceCb(new NumberLiteralExpression(new Token$3(Math.sin(argAsNumber(0)) + "")));
				break;
			case "cos":
				this.log$S("folding " + member.getNotation$());
				replaceCb(new NumberLiteralExpression(new Token$3(Math.cos(argAsNumber(0)) + "")));
				break;
			}
		}
		if (holderType.getClassDef$().classFullName$() === "String") {
			...
			case "fromCharCode":
				this.log$S("folding " + member.getNotation$());
				s = "";
				callExpr.getArguments$().forEach((function (arg) {
					s += String.fromCharCode(+arg.getToken$().getValue$());
				}));
		...
		case "charCodeAt":
			...
			replaceCb(new NumberLiteralExpression(new Token$3(recvStr.charCodeAt(argAsNumber(0)) + "")));
			break;
		}
	}
};
...
_FoldConstantCommand.prototype._foldNumericBinaryExpression$LBinaryExpression$F$LExpression$V$ = function (expr, replaceCb) {
	...
	function exprIsOne(expr) {
		return expr instanceof NumberLiteralExpression && +expr.getToken$().getValue$() === 1;
	}
	switch (expr.getToken$().getValue$()) {
	case "+":
...
_FoldConstantCommand.prototype._foldNumericBinaryExpressionAsInteger$LBinaryExpression$F$LExpression$V$F$III$ = function (expr, replaceCb, calcCb) {
	var value;
	value = calcCb((+expr.getFirstExpr$().getToken$().getValue$() | 0), (+expr.getSecondExpr$().getToken$().getValue$() | 0));
...
_FoldConstantCommand.prototype._toFoldedExpr$LExpression$LType$ = function (expr, type) {
	if (expr instanceof NullExpression) {
		...
		if (type.resolveIfNullable$().equals$LType$(Type.integerType)) {
			return new IntegerLiteralExpression(new Token$3((expr.getToken$().getValue$() | 0) + ""));
		}
		return expr;
	} else if (expr instanceof StringLiteralExpression) {
		return expr;
...
_FoldConstantCommand.prototype._foldAsExpression$LAsExpression$F$LExpression$V$ = function (expr, replaceCb) {
	...
	if (expr.getType$().equals$LType$(Type.stringType)) {
		if (baseExpr.getType$().equals$LType$(Type.stringType)) {
			...
			replaceCb(new StringLiteralExpression(new Token$2(Util$encodeStringLiteral$S(baseExpr.getToken$().getValue$()), false)));
		}
		...
		if (baseExpr.getType$().equals$LType$(Type.numberType)) {
			...
			replaceCb(new NumberLiteralExpression(new Token$2(+Util$decodeStringLiteral$S(baseExpr.getToken$().getValue$()) + "", false)));
		} else if (baseExpr instanceof IntegerLiteralExpression) {
			this.log$S("folding type cast: int literal as number");
			replaceCb(new NumberLiteralExpression(new Token$2(+baseExpr.getToken$().getValue$() + "", false)));
		}
		...
		if (baseExpr.getType$().equals$LType$(Type.integerType)) {
			...
			replaceCb(new IntegerLiteralExpression(new Token$2((Util$decodeStringLiteral$S(baseExpr.getToken$().getValue$()) | 0) + "", false)));
		} else if (baseExpr instanceof NumberLiteralExpression) {
			this.log$S("folding type cast: number literal as int");
			replaceCb(new IntegerLiteralExpression(new Token$2((baseExpr.getToken$().getValue$() | 0) + "", false)));
		}
		...
		if (baseExpr.getType$().equals$LType$(Type.booleanType)) {
			...
			replaceCb(new BooleanLiteralExpression(new Token$2(!! Util$decodeStringLiteral$S(baseExpr.getToken$().getValue$()) + "", false)));
		} else if (baseExpr instanceof NumberLiteralExpression) {
			this.log$S("folding type cast: number literal as boolean");
			replaceCb(new BooleanLiteralExpression(new Token$2((+baseExpr.getToken$().getValue$() ? "true" : "false"), false)));
		} else if (baseExpr instanceof IntegerLiteralExpression) {
			this.log$S("folding type cast: integer literal as boolean");
			replaceCb(new BooleanLiteralExpression(new Token$2((baseExpr.getToken$().getValue$() | 0 ? "true" : "false"), false)));
		}
	}
};
...
_InlineOptimizeCommand.prototype._getArgsAndThisIfCallExprIsInlineable$LCallExpression$ = function (callExpr) {
	...
	this.optimizeFunction$LMemberFunctionDefinition$(callingFuncDef);
	receiverExpr = null;
	if ((((callingFuncDef.flags$() & ClassDefinition.IS_STATIC) | 0)) === 0) {
		calleeExpr = callExpr.getExpr$();
		if (! (calleeExpr instanceof PropertyExpression)) {
...
_InlineOptimizeCommand.prototype._functionIsInlineable$LMemberFunctionDefinition$ = function (funcDef) {
	...
	if (stash.isInlineable == null) {
		stash.isInlineable = (function () {
			...
			requestsInline = (((funcDef.flags$() & ClassDefinition.IS_INLINE) | 0)) !== 0;
			if (requestsInline) {
...
_InlineOptimizeCommand.prototype._createVarsAndInit$LMemberFunctionDefinition$LMemberFunctionDefinition$ALExpression$F$LExpression$V$ = function (callerFuncDef, calleeFuncDef, argsAndThisAndLocals, initArgExpr) {
	...
	if ((((calleeFuncDef.flags$() & ClassDefinition.IS_STATIC) | 0)) === 0) {
		thisIdx = argsAndThisAndLocals.length - 1;
		recvExpr = argsAndThisAndLocals[thisIdx];
		if (! (recvExpr instanceof LeafExpression || _Util$0$exprIsIndependent$LExpression$(recvExpr) && argUsed["this"] <= 1)) {
	...
	for (i = 0; i < formalArgs.length; ++i) {
		...
		if (! (argExpr instanceof LeafExpression || _Util$0$exprIsIndependent$LExpression$(argExpr) && numberOfUsed <= 1)) {
...
_InlineOptimizeCommand.prototype._functionHasThis$LMemberFunctionDefinition$ = function (funcDef) {
	do {
		if ((((funcDef.flags$() & ClassDefinition.IS_STATIC) | 0)) === 0) {
			return true;
		}
...
_UnboxOptimizeCommand.prototype._newExpressionCanUnbox$LExpression$ = function (newExpr) {
	...
	var ctor;
	var stash;
	if ((((newExpr.getType$().getClassDef$().flags$() & ClassDefinition.IS_NATIVE) | 0)) !== 0) {
		return false;
	}
	...
	this.getCompiler$().forEachClassDef$F$LParser$LClassDefinition$B$((function (parser, classDef) {
		if (classDef.className$() === "JSX") {
			classDef.forEachMemberVariable$F$LMemberVariableDefinition$B$((function (memberVariable) {
				var falseExpr;
				if (memberVariable.name$() === "DEBUG" && (((memberVariable.flags$() & ClassDefinition.IS_STATIC) | 0)) !== 0) {
...
_TailRecursionOptimizeCommand.prototype.optimizeFunction$LMemberFunctionDefinition$ = function (funcDef) {
	...
	var statements;
	var body;
	if ((((funcDef.flags$() & (((((ClassDefinition.IS_OVERRIDE | ClassDefinition.IS_ABSTRACT) | 0) | ClassDefinition.IS_NATIVE) | 0))) | 0)) !== 0 || (((funcDef.flags$() & (((ClassDefinition.IS_STATIC | ClassDefinition.IS_FINAL) | 0))) | 0)) === 0) {
		return false;
	}
	altered = false;
	statements = funcDef.getStatements$();
...
Compiler.prototype.setTransformer$LCodeTransformer$ = function (transformer) {
...
Compiler.prototype._transform$ = function () {
	if (this._transformer != null) {
		this._transformer.setup$LCompiler$LEmitter$(this, this._emitter).performTransformation$();
	}
};
...
Compiler.prototype._generateCode$ALCompileError$ = function (errors) {
	...
	for (i = 0; i < this._parsers.length; ++i) {
		...
		this._parsers[i].getTemplateClassDefs$().forEach((function (templateClassDef) {
			if ((((templateClassDef.flags$() & ClassDefinition.IS_NATIVE) | 0)) !== 0 && templateClassDef.getNativeSource$() != null) {
	...
	for (i = 0; i < classDefs.length; ) {
		if ((((classDefs[i].flags$() & ClassDefinition.IS_NATIVE) | 0)) !== 0) {
			maxIndexOfClasses = - 1;
		} else {
...
Compiler.prototype._exportEntryPoints$ = function () {
	...
	this.forEachClassDef$F$LParser$LClassDefinition$B$((function (parser, classDef) {
		...
		case "_Main":
			classDef.setFlags$N(((classDef.flags$() | ClassDefinition.IS_EXPORT) | 0));
			classDef.forEachMemberFunction$F$LMemberFunctionDefinition$B$((function (funcDef) {
				if ((((funcDef.flags$() & ClassDefinition.IS_STATIC) | 0)) !== 0 && funcDef.name$() === "main" && funcDef.getArguments$().length === 1 && Util$isArrayOf$LClassDefinition$LType$(funcDef.getArgumentTypes$()[0].getClassDef$(), Type.stringType)) {
					funcDef.setFlags$N(((funcDef.flags$() | ClassDefinition.IS_EXPORT) | 0));
				}
				return true;
			}));
			break;
		case "_Test":
			classDef.setFlags$N(((classDef.flags$() | ClassDefinition.IS_EXPORT) | 0));
			classDef.forEachMemberFunction$F$LMemberFunctionDefinition$B$((function (funcDef) {
				if ((((funcDef.flags$() & ClassDefinition.IS_STATIC) | 0)) === 0 && (funcDef.name$().match(/^test/) || funcDef.name$() === "constructor") && funcDef.getArguments$().length === 0) {
					funcDef.setFlags$N(((funcDef.flags$() | ClassDefinition.IS_EXPORT) | 0));
				}
				return true;
			}));
...
function CompletionCandidates$makeClassCandidate$LClassDefinition$(classDef) {
	...
	if ((((classDef.flags$() & ClassDefinition.IS_INTERFACE) | 0)) !== 0) {
		data.kind = "interface";
	} else if ((((classDef.flags$() & ClassDefinition.IS_MIXIN) | 0)) !== 0) {
		data.kind = "mixin";
	} else {
		data.kind = "class";
	}
...
_CompletionCandidatesOfProperty.prototype.getCandidates$AHX = function (candidates) {
	...
	classDef.forEachClassToBase$F$LClassDefinition$B$((function (c) {
		c.forEachMember$F$LMemberDefinition$B$((function (member) {
			if (((((member.flags$() & ClassDefinition.IS_STATIC) | 0)) !== 0) === isStatic) {
...
function _CompletionCandidatesOfProperty$_makeMemberCandidate$LMemberDefinition$(member) {
	...
	var docComment;
	var mf;
	kind = (((member.flags$() & ClassDefinition.IS_STATIC) | 0) ? "static member" : "member");
...
DocumentGenerator.prototype._buildDocOfClass$LParser$LClassDefinition$ = function (parser, classDef) {
	...
	classDef.forEachMemberFunction$F$LMemberFunctionDefinition$B$((function (funcDef) {
		if (! (funcDef instanceof InstantiatedMemberFunctionDefinition) && $this._isConstructor$LMemberFunctionDefinition$(funcDef) && (((funcDef.flags$() & ClassDefinition.IS_DELETE) | 0)) === 0 && ! $this._isPrivate$LMemberDefinition$(funcDef)) {
...
DocumentGenerator.prototype._buildDocOfFunction$LParser$LMemberFunctionDefinition$ = function (parser, funcDef) {
	...
	var argsHTML;
	_ = "";
	ignoreFlags = ((((funcDef.getClassDef$().flags$() & (((ClassDefinition.IS_FINAL | ClassDefinition.IS_NATIVE) | 0))) | 0) | ClassDefinition.IS_INLINE) | 0);
	funcName = (this._isConstructor$LMemberFunctionDefinition$(funcDef) ? "new " + this._name$S(funcDef.getClassDef$().classFullName$()) : this._flagsToHTML$N(((funcDef.flags$() & ~ ignoreFlags) | 0)) + " function " + this._name$S(funcDef.name$()));
	args = funcDef.getArguments$();
...
DocumentGenerator.prototype._flagsToHTML$N = function (flags) {
	...
	if ((((flags & ClassDefinition.IS_CONST) | 0)) !== 0) {
		strs.push("const");
	}
	if ((((flags & ClassDefinition.IS_READONLY) | 0)) !== 0) {
		strs.push("__readonly__");
	}
	if ((((flags & ClassDefinition.IS_ABSTRACT) | 0)) !== 0) {
		strs.push("abstract");
	}
	if ((((flags & ClassDefinition.IS_FINAL) | 0)) !== 0) {
		strs.push("final");
	}
	if ((((flags & ClassDefinition.IS_OVERRIDE) | 0)) !== 0) {
		strs.push("override");
	}
	if ((((flags & ClassDefinition.IS_INLINE) | 0)) !== 0) {
		strs.push("inline");
	}
	if ((((flags & ClassDefinition.IS_NATIVE) | 0)) !== 0) {
		strs.push("native");
	}
	if ((((flags & ClassDefinition.IS_EXPORT) | 0)) !== 0) {
...
DocumentGenerator.prototype._isConstructor$LMemberFunctionDefinition$ = function (funcDef) {
	return funcDef.name$() === "constructor" && (((funcDef.flags$() & ClassDefinition.IS_STATIC) | 0)) === 0;
};
...
DocumentGenerator.prototype._isPrivate$LMemberDefinition$ = function (memberDef) {
	return !! (memberDef.name$().charAt(0) === "_" || memberDef.getDocComment$() && memberDef.getDocComment$().getTagByName$S('private') || (((memberDef.flags$() & ClassDefinition.IS_GENERATED) | 0)) !== 0);
};
...
_ReturnStatementTransformer.prototype._replaceControlStructuresWithGotos$ = function () {
	...
	if (this._statement.getExpr$() != null) {
		returnLocal = this._transformer._getTopReturnLocal$();
		if (returnLocal == null) {
	...
	this._transformer._emit$LStatement$(new GotoStatement("$L_exit"));
};
...
_DoWhileStatementTransformer.prototype._replaceControlStructuresWithGotos$ = function () {
	...
	this._transformer._emit$LStatement$(new GotoStatement(bodyLabel));
	this._transformer._emit$LStatement$(new LabelStatement(bodyLabel));
	...
	this._transformer._emit$LStatement$(new GotoStatement(testLabel));
	this._transformer._emit$LStatement$(new LabelStatement(testLabel));
...
_ForStatementTransformer.prototype._replaceControlStructuresWithGotos$ = function () {
	...
	this._transformer._emit$LStatement$(new GotoStatement(initLabel));
	this._transformer._emit$LStatement$(new LabelStatement(initLabel));
	...
	this._transformer._emit$LStatement$(new GotoStatement(postLabel));
	this._transformer._emit$LStatement$(new LabelStatement(postLabel));
...
_IfStatementTransformer.prototype._replaceControlStructuresWithGotos$ = function () {
	...
	this._transformer._emit$LStatement$(new LabelStatement(succLabel));
	...
	this._transformer._emit$LStatement$(new LabelStatement(failLabel));
...
_SwitchStatementTransformer.prototype._replaceControlStructuresWithGotos$ = function () {
	var testLabel;
	var endLabel;
	testLabel = "$L_test_switch_" + (this.getID$() + "");
	this._transformer._emit$LStatement$(new GotoStatement(testLabel));
	this._transformer._emit$LStatement$(new LabelStatement(testLabel));
...
_SwitchStatementTransformer.prototype._emitConditionalSwitch$ = function () {
	var statements;
	var switchCases;
	var i;
	var stmt;
	...
	for (i = 0; i < statements.length; ++i) {
		...
		if (stmt instanceof CaseStatement) {
			...
			switchCases.push(new ReturnStatement(new Token$2("return", false), null));
	...
	this._transformer._emit$LStatement$(new SwitchStatement(this._statement.getToken$(), this._statement.getLabel$(), this._statement.getExpr$(), switchCases));
};
...
function CodeTransformer() {
	this._compiler = null;
	this._emitter = null;
	this._transformingFuncDef = null;
...
CodeTransformer.prototype.setup$LCompiler$LEmitter$ = function (compiler, emitter) {
	var builtins;
	var i;
	this._compiler = compiler;
	this._emitter = emitter;
	builtins = compiler.getBuiltinParsers$()[0];
	this._stopIterationClassDef = builtins.lookup$ALCompileError$LToken$S([  ], null, "StopIteration");
...
CodeTransformer.prototype.setForceTransform$B = function (force) {
	this._forceTransform = force;
};


CodeTransformer.prototype.getEmitter$ = function () {
	return this._emitter;
};


CodeTransformer.prototype._functionIsTransformable$LMemberFunctionDefinition$ = function (funcDef) {
	var $this = this;
...
CodeTransformer.prototype._getAllClosures$ = function () {
	var $this = this;
	var closures;
	closures = [];
...
CodeTransformer.prototype.performTransformation$ = function () {
	var $this = this;
	...
	this._getAllClosures$().forEach((function (funcDef) {
		if (funcDef.isGenerator$()) {
			$this._transformGenerator$LMemberFunctionDefinition$(funcDef);
		}
	}));
};


CodeTransformer.prototype._transformGenerator$LMemberFunctionDefinition$ = function (funcDef) {
	this._compileYields$LMemberFunctionDefinition$(funcDef);
};


CodeTransformer.prototype.getTransformingFuncDef$ = function () {
	return this._transformingFuncDef;
};


CodeTransformer.prototype._doCPSTransform$LMemberFunctionDefinition$ = function (funcDef) {
	var $this = this;
	this._doCPSTransform$LMemberFunctionDefinition$F$SALStatement$V$(funcDef, (function (name, statements) {
	}));
};


CodeTransformer.prototype._doCPSTransform$LMemberFunctionDefinition$F$SALStatement$V$ = function (funcDef, postFragmentationCallback) {
	var returnLocal;
	var returnLocalName;
	var statements;
	var i;
	...
	if (! Type.voidType.equals$LType$(funcDef.getReturnType$())) {
		returnLocalName = "$return" + (CodeTransformer$_getFunctionNestDepth$LMemberFunctionDefinition$(funcDef) + "");
		returnLocal = new LocalVariable$0(new Token$2(returnLocalName, false), funcDef.getReturnType$());
		funcDef.getLocals$().push(returnLocal);
		this._enterFunction$LLocalVariable$(returnLocal);
	}
	statements = [];
	this._setOutputStatements$ALStatement$(statements);
	for (i = 0; i < funcDef.getStatements$().length; ++i) {
		this._getStatementTransformerFor$LStatement$(funcDef.getStatements$()[i]).replaceControlStructuresWithGotos$();
	}
	statements.unshift(new GotoStatement("$L_enter"), new LabelStatement("$L_enter"));
	statements.push(new GotoStatement("$L_exit"), new LabelStatement("$L_exit"));
	funcDef._statements = statements;
	if (! Type.voidType.equals$LType$(funcDef.getReturnType$())) {
		funcDef._statements.push(new ReturnStatement(new Token$2("return", false), new LocalExpression(returnLocal.getName$(), returnLocal)));
		this._leaveFunction$();
	}
	this._eliminateGotos$LMemberFunctionDefinition$F$SALStatement$V$(funcDef, postFragmentationCallback);
};


CodeTransformer.prototype._eliminateGotos$LMemberFunctionDefinition$F$SALStatement$V$ = function (funcDef, postFragmentationCallback) {
	var statements;
	var labels;
	var i;
	var name;
	...
	for (i = 0; i < statements.length; ++i) {
		if (statements[i] instanceof LabelStatement && labels[statements[i].getName$()] == null) {
			...
			labels[name] = new LocalVariable$0(new Token$2(name, true), new StaticFunctionType(null, Type.voidType, [  ], true));
	...
	for (i = 0; i < statements.length; ++i) {
		...
		if (stmt instanceof GotoStatement) {
			name = stmt.getLabel$();
			statements[i] = new ReturnStatement(new Token$2("return", false), new CallExpression(new Token$2("(", false), new LocalExpression(null, labels[name]), [  ]));
		} else if (stmt instanceof IfStatement) {
			ifStmt = stmt;
			succLabel = ifStmt.getOnTrueStatements$()[0].getLabel$();
			ifStmt.getOnTrueStatements$()[0] = new ReturnStatement(new Token$2("return", false), new CallExpression(new Token$2("(", false), new LocalExpression(null, labels[succLabel]), [  ]));
			failLabel = ifStmt.getOnFalseStatements$()[0].getLabel$();
			ifStmt.getOnFalseStatements$()[0] = new ReturnStatement(new Token$2("return", false), new CallExpression(new Token$2("(", false), new LocalExpression(null, labels[failLabel]), [  ]));
			...
			for (j = 0; j < switchStmt.getStatements$().length; ++j) {
				if (switchStmt.getStatements$()[j] instanceof GotoStatement) {
					...
					switchStmt.getStatements$()[j] = new ReturnStatement(new Token$2("return", false), new CallExpression(new Token$2("(", false), new LocalExpression(null, labels[name]), [  ]));
				}
			}
		}
	}
	...
	while (i < statements.length) {
		...
		block = this._createAnonymousFunction$LMemberFunctionDefinition$LToken$ALArgumentDeclaration$LType$(funcDef, null, [  ], this._transformingFuncDef.getReturnType$());
		block._statements = body;
		basicBlocks.push(new ExpressionStatement(new AssignmentExpression(new Token$2("=", false), new LocalExpression(null, labels[currentLabel.getName$()]), new FunctionExpression(new Token$2("function", false), block))));
	}
	funcDef._statements = basicBlocks.concat(entry);
};


CodeTransformer.prototype._compileYields$LMemberFunctionDefinition$ = function (funcDef) {
	var $this = this;
	var yieldingType;
	var genType;
	var genLocalName;
	...
	genLocalName = "$generator" + (CodeTransformer$_getGeneratorNestDepth$LMemberFunctionDefinition$(funcDef) + "");
	genLocal = new LocalVariable$0(new Token$2(genLocalName, false), genType);
	funcDef.getLocals$().push(genLocal);
	newExpr = new NewExpression(new Token$2("new", false), new ObjectType(this._stopIterationClassDef), [  ]);
	newExpr.analyze$LAnalysisContext$LExpression$(new AnalysisContext([  ], null, null), null);
	funcDef.getStatements$().push(new ThrowStatement(new Token$2("throw", false), newExpr));
	this._doCPSTransform$LMemberFunctionDefinition$F$SALStatement$V$(funcDef, (function (label, statements) {
		var idx;
		if (2 <= statements.length && statements[statements.length - 2] instanceof YieldStatement) {
			idx = statements.length - 2;
			statements.splice(idx, 2, new ExpressionStatement(new AssignmentExpression(new Token$2("=", false), new PropertyExpression$0(new Token$2(".", false), new LocalExpression(new Token$2(genLocalName, false), genLocal), new Token$2("__value", false), [  ], yieldingType), statements[idx].getExpr$())), new ExpressionStatement(new AssignmentExpression(new Token$2("=", false), new PropertyExpression$0(new Token$2(".", false), new LocalExpression(new Token$2(genLocalName, false), genLocal), new Token$2("__next", true), [  ], new StaticFunctionType(null, $this._transformingFuncDef.getReturnType$(), [  ], true)), statements[idx + 1].getExpr$().getExpr$())));
		}
	}));
	newExpr = new NewExpression(new Token$2("new", false), genType, [  ]);
	newExpr.analyze$LAnalysisContext$LExpression$(new AnalysisContext([  ], null, null), null);
	funcDef.getStatements$().unshift(new ExpressionStatement(new AssignmentExpression(new Token$2("=", false), new LocalExpression(new Token$2(genLocalName, false), genLocal), newExpr)));
	statements = funcDef.getStatements$();
	statements.splice(statements.length - 1, 1, new ExpressionStatement(new AssignmentExpression(new Token$2("=", false), new PropertyExpression$0(new Token$2(".", false), new LocalExpression(new Token$2(genLocalName, false), genLocal), new Token$2("__next", true), [  ], new StaticFunctionType(null, this._transformingFuncDef.getReturnType$(), [  ], true)), new LocalExpression(new Token$2("$L_enter", true), statements[statements.length - 1].getExpr$().getExpr$().getLocal$()))));
	statements.push(new ReturnStatement(new Token$2("return", false), new LocalExpression(new Token$2("$generator", false), genLocal)));
};


CodeTransformer.prototype._instantiateGeneratorType$LType$ = function (yieldingType) {
	var $this = this;
	var genClassDef;
	var createContext;
	var parser;
	genClassDef = this._jsxGeneratorClassDef.getParser$().lookupTemplate$ALCompileError$LTemplateInstantiationRequest$F$LParser$LClassDefinition$LClassDefinition$$([  ], new TemplateInstantiationRequest(null, "__jsx_generator", [ yieldingType ]), (function (parser, classDef) {
		return null;
	}));
	createContext = (function (parser) {
	...
	parser = this._jsxGeneratorClassDef.getParser$();
...
function CodeTransformer$_getGeneratorNestDepth$LMemberFunctionDefinition$(funcDef) {
	var depth;
	var parent;
	depth = 0;
...
CodeTransformer._getGeneratorNestDepth$LMemberFunctionDefinition$ = CodeTransformer$_getGeneratorNestDepth$LMemberFunctionDefinition$;

function CodeTransformer$_getFunctionNestDepth$LMemberFunctionDefinition$(funcDef) {
	var depth;
	var parent;
	depth = 0;
	while ((parent = funcDef.getParent$()) != null) {
...
CodeTransformer._getFunctionNestDepth$LMemberFunctionDefinition$ = CodeTransformer$_getFunctionNestDepth$LMemberFunctionDefinition$;

CodeTransformer.prototype._setOutputStatements$ALStatement$ = function (statements) {
	this._outputStatements = statements;
};


CodeTransformer.prototype._emit$LStatement$ = function (statement) {
	this._outputStatements.push(statement);
};


CodeTransformer.prototype._emitExpressionStatement$LExpression$ = function (expr) {
	this._emit$LStatement$(new ExpressionStatement(expr));
};


CodeTransformer.prototype._emitConditionalBranch$LExpression$SS = function (expr, succLabel, failLabel) {
	this._emit$LStatement$(new IfStatement(new Token$2("if", false), expr, [ new GotoStatement(succLabel) ], [ new GotoStatement(failLabel) ]));
};


CodeTransformer.prototype._getStatementTransformerByLabel$S = function (label) {
	var i;
	var trans;
...
CodeTransformer.prototype._getTopLabelledBlock$ = function () {
	return this._labelStack[this._labelStack.length - 1];
};


CodeTransformer.prototype._enterLabelledBlock$L_LabellableStatementTransformer$ = function (transformer) {
	this._labelStack.push(transformer);
};


CodeTransformer.prototype._leaveLabelledBlock$ = function () {
	this._labelStack.pop();
};


CodeTransformer.prototype._getTopReturnLocal$ = function () {
	return this._returnLocals[this._returnLocals.length - 1];
};


CodeTransformer.prototype._enterFunction$LLocalVariable$ = function (returnLocal) {
	this._returnLocals.push(returnLocal);
};


CodeTransformer.prototype._leaveFunction$ = function () {
	this._returnLocals.pop();
};


CodeTransformer.prototype._createFreshArgumentDeclaration$LType$ = function (type) {
	var id;
	id = this._numUniqVar++;
...
CodeTransformer.prototype._createFreshLocalVariable$LType$ = function (type) {
	var id;
	id = this._numUniqVar++;
	return new LocalVariable$0(new Token$2("$a" + (id + ""), true), type);
};
...
CodeTransformer.prototype._createAnonymousFunction$LMemberFunctionDefinition$LToken$ALArgumentDeclaration$LType$ = function (parent, token, args, returnType) {
	var funcDef;
	if (token == null) {
		token = new Token$2("function", false);
	}
	funcDef = new MemberFunctionDefinition(token, null, ClassDefinition.IS_STATIC, returnType, args, [  ], [  ], [  ], null, null);
	Util$linkFunction$LMemberFunctionDefinition$LMemberFunctionDefinition$(funcDef, parent);
	return funcDef;
};


CodeTransformer.prototype._createIdentityFunction$LMemberFunctionDefinition$LType$ = function (parent, type) {
	var arg;
	var identity;
	arg = this._createFreshArgumentDeclaration$LType$(type);
...
_Minifier$x2E_MinifyingNamer.prototype.getNameOfClass$LClassDefinition$ = function (classDef) {
	...
	if ((((classDef.flags$() & (((ClassDefinition.IS_NATIVE | ClassDefinition.IS_FAKE) | 0))) | 0)) === 0 && ! this._isCounting$()) {
...
Meta.LAST_COMMIT_HASH = "f82369af9e74eb683e78096905a5795cdb8c8615";
Meta.LAST_COMMIT_DATE = "2014-01-16 18:56:32 +0900";
...
var $__jsx_classMap = {
	...
	"src/analysis.jsx": {
		...
		LocalVariable$LToken$LType$: LocalVariable$0,
