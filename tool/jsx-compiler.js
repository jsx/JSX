#!/usr/local/Cellar/node/0.8.14/bin/node
var JSX = {};
(function () {
...
/**
 * class _JSX extends Object
 * @constructor
 */
function _JSX() {
}

_JSX.prototype = new Object;
/**
 * @constructor
 */
function _JSX$() {
...
_JSX$.prototype = new _JSX;

/**
 * @param {!string} name
 * @return {*}
 */
_JSX.meta$S = function (name) {
	/** @type {!string} */
	var j;
	if (_JSX._meta == null) {
		j = node.fs.readFileSync(node.__dirname + "/../package.json");
		_JSX._meta = JSON.parse(j);
	}
	return _JSX._meta[name];
};

var _JSX$meta$S = _JSX.meta$S;
 ...
 */
_JSX.execNodeJS$SSAS = function (scriptFile, script, args) {
	...
	if (process.env.JSX_RUNJS) {
		child = node.child_process.spawn((function (v) {
			if (! (v != null)) {
				debugger;
				throw new Error("[src/jsx.jsx:187] null access");
			}
			return v;
...
_JSX.main$AS = function (args) {
	...
	getoptarg = (function () {
		if (args.length <= argIndex) {
			console.error("option " + (function (v) {
				if (! (v != null)) {
					debugger;
					throw new Error("[src/jsx.jsx:249] null access");
				}
				return v;
	...
	NEXTOPT:
		switch ((function (v) {
			if (! (v != null)) {
				debugger;
				throw new Error("[src/jsx.jsx:271] null access");
			}
			return v;
		}(opt))) {
		case "--add-search-path":
			...
			compiler.addSearchPath$S((function (v) {
				if (! (v != null)) {
					debugger;
					throw new Error("[src/jsx.jsx:276] null access");
				}
				return v;
			}(optarg)));
			break;
		...
		case "--mode":
			...
			switch ((function (v) {
				if (! (v != null)) {
					debugger;
					throw new Error("[src/jsx.jsx:292] null access");
				}
				return v;
			}(optarg))) {
			case "compile":
			...
			case "doc":
				...
				break;
			default:
				console.error("unknown mode: " + (function (v) {
					if (! (v != null)) {
						debugger;
						throw new Error("[src/jsx.jsx:303] null access");
					}
					return v;
				}(optarg)));
				return 1;
		...
		case "--complete":
			...
			completionRequest = (function () {
				...
				return new CompletionRequest$NN(+(function (v) {
					if (! (v != null)) {
						debugger;
						throw new Error("[src/jsx.jsx:313] null access");
					}
					return v;
				}(a[0])), +(function (v) {
					if (! (v != null)) {
		...
		case "--target":
			...
			switch ((function (v) {
				if (! (v != null)) {
					debugger;
					throw new Error("[src/jsx.jsx:321] null access");
				}
				return v;
			}(optarg))) {
			case "javascript":
			...
			default:
				console.error("unknown target: " + (function (v) {
					if (! (v != null)) {
						debugger;
						throw new Error("[src/jsx.jsx:328] null access");
					}
					return v;
				}(optarg)));
				return 1;
		...
		case "--warn":
			...
			optarg.split(",").forEach((function (type) {
				switch ((function (v) {
					if (! (v != null)) {
						debugger;
						throw new Error("[src/jsx.jsx:350] null access");
					}
					return v;
				}(type))) {
				case "none":
				...
				case "deprecated":
					...
					break;
				default:
					console.error("unknown warning type: " + (function (v) {
						if (! (v != null)) {
							debugger;
							throw new Error("[src/jsx.jsx:370] null access");
						}
						return v;
					}(type)));
				}
		...
		case "--executable":
			...
			switch ((function (v) {
				if (! (v != null)) {
					debugger;
					throw new Error("[src/jsx.jsx:378] null access");
				}
				return v;
			}(optarg))) {
			case "web":
		...
		case "--profile":
			...
			break;
		case "--version":
			console.log(_JSX$meta$S("version"));
			return 0;
		case "--help":
			_JSX$printHelp$();
			return 0;
		default:
			...
			if (switchOpt != null) {
				...
				switch ((function (v) {
					if (! (v != null)) {
						debugger;
						throw new Error("[src/jsx.jsx:419] null access");
					}
					return v;
				}(switchOpt[2]))) {
				case "type-check":
			...
			console.error("unknown option: " + (function (v) {
				if (! (v != null)) {
					debugger;
					throw new Error("[src/jsx.jsx:439] null access");
				}
				return v;
			}(opt)));
			return 1;
	...
	if (inputFilename != null) {
		platform.setFileContent$SS((function (v) {
			if (! (v != null)) {
				debugger;
				throw new Error("[src/jsx.jsx:451] null access");
			}
			return v;
	...
	compiler.addSourceFile$LToken$SLCompletionRequest$(null, (function (v) {
		if (! (v != null)) {
			debugger;
			throw new Error("[src/jsx.jsx:454] null access");
		}
		return v;
	...
	case Compiler.MODE_DOC:
		...
		if (compiler.compile$()) {
			new DocumentGenerator$LCompiler$(compiler).setOutputPath$S((function (v) {
				if (! (v != null)) {
					debugger;
					throw new Error("[src/jsx.jsx:478] null access");
				}
				return v;
	...
	output = emitter.getOutput$SUSUS((function (v) {
		if (! (v != null)) {
			debugger;
			throw new Error("[src/jsx.jsx:513] null access");
		}
		return v;
	...
	if (emitter instanceof JavaScriptEmitter) {
		if (! runImmediately) {
			...
			if (outputFile != null) {
				...
				if (executable == "node") {
					node.fs.chmodSync((function (v) {
						if (! (v != null)) {
							debugger;
							throw new Error("[src/jsx.jsx:523] null access");
						}
						return v;
					}(outputFile)), "0755");
				}
			...
			_JSX$execNodeJS$SSAS((function (v) {
				if (! (v != null)) {
					debugger;
					throw new Error("[src/jsx.jsx:529] null access");
				}
				return v;
			}(sourceFile)), output, args.slice(argIndex));
		}
	} else {
...
_Main.main$AS = function (args) {
	...
	/** @type {*} */
	var exitIfFlushed;
	exitCode = _JSX$main$AS(_Main$getEnvOpts$().concat(process.argv.slice(2)));
	if (exitCode === 0) {
		return;
	}
...
DocumentGenerator.prototype._classDefToHTML$LParser$LClassDefinition$ = function (parser, classDef) {
	...
	_ += "</a>\n";
	_ = _.trim();
	this._classDefToHTMLCache.push(new $TEMPLATECLASS$174$LClassDefinition$S(classDef, _));
	return _;
};
...
function NodePlatform$() {
	...
	Platform$.call(this);
	eval = (function (o) { return typeof(o) === "function" ? o : null; })(js.global.eval);
	node.fs = eval('require("fs")');
	node.path = eval('require("path")');
	node.child_process = eval('require("child_process")');
	node.__dirname = eval("__dirname") + "";
 ...
 */
NodePlatform.prototype.setFileContent$SS = function (name, content) {
...
NodePlatform.prototype.save$USS = function (outputFile, content) {
	if (outputFile == null) {
		...
		node.fs.writeFileSync((function (v) {
			if (! (v != null)) {
				debugger;
				throw new Error("[src/jsx.jsx:107] null access");
			}
			return v;
		}(outputFile)), content);
	}
 ...
 * @return {!number}
 */
_Util$0.numberOfStatements$ALStatement$ = function (statements) {
	/** @type {!number} */
	var n;
	/** @type {*} */
	var onStatement;
...
var _Util$0$numberOfStatements$ALStatement$ = _Util$0.numberOfStatements$ALStatement$;
 ...
 * @return {!boolean}
 */
_Util$0.handleSubStatements$F$ALStatement$B$LStatement$ = function (cb, statement) {
	/** @type {!boolean} */
	var ret;
	ret = false;
...
var _Util$0$handleSubStatements$F$ALStatement$B$LStatement$ = _Util$0.handleSubStatements$F$ALStatement$B$LStatement$;

/**
 * @param {MemberFunctionDefinition} funcDef
 * @return {!string}
 */
_Util$0.getFuncName$LMemberFunctionDefinition$ = function (funcDef) {
	/** @type {ClassDefinition} */
	var classDef;
	/** @type {!string} */
	var s;
...
var _Util$0$getFuncName$LMemberFunctionDefinition$ = _Util$0.getFuncName$LMemberFunctionDefinition$;

/**
 * @param {ClassDefinition} classDef
 * @return {!boolean}
 */
_Util$0.classIsNative$LClassDefinition$ = function (classDef) {
...
var _Util$0$classIsNative$LClassDefinition$ = _Util$0.classIsNative$LClassDefinition$;

/**
 * @param {Expression} expr
 * @return {!boolean}
 */
_Util$0.exprHasSideEffects$LExpression$ = function (expr) {
	/** @type {*} */
	var onExpr;
...
var _Util$0$exprHasSideEffects$LExpression$ = _Util$0.exprHasSideEffects$LExpression$;

/**
 * @param {MemberFunctionDefinition} funcDef
 * @param {*} optimizeExpressions
 */
_Util$0.optimizeBasicBlock$LMemberFunctionDefinition$F$ALExpression$V$ = function (funcDef, optimizeExpressions) {
	/** @type {*} */
...
var _Util$0$optimizeBasicBlock$LMemberFunctionDefinition$F$ALExpression$V$ = _Util$0.optimizeBasicBlock$LMemberFunctionDefinition$F$ALExpression$V$;
...
_FunctionOptimizeCommand.prototype.performOptimization$ = function () {
	...
	doit = (function (funcDef) {
		$this.log$S("starting optimization of " + _Util$0$getFuncName$LMemberFunctionDefinition$(funcDef));
		$this.optimizeFunction$LMemberFunctionDefinition$(funcDef);
		$this.log$S("finished optimization of " + _Util$0$getFuncName$LMemberFunctionDefinition$(funcDef));
	});
...
_DeadCodeEliminationOptimizeCommand.prototype._removeExpressionStatementsWithoutSideEffects$LMemberFunctionDefinition$ = function (funcDef) {
	...
	(onStatements = (function (statements) {
		...
		var i;
		for (i = 0; i < statements.length; ) {
			if (statements[i] instanceof ExpressionStatement && ! _Util$0$exprHasSideEffects$LExpression$((function (o) { return o instanceof ExpressionStatement ? o : null; })(statements[i]).getExpr$())) {
				shouldRetry = true;
				statements.splice(i, 1);
			} else {
...
_DeadCodeEliminationOptimizeCommand.prototype._optimizeFunction$LMemberFunctionDefinition$ = function (funcDef) {
	...
	(onStatements = (function (statements) {
		...
		for (i = statements.length - 1; i >= 0; -- i) {
			...
			if (statement instanceof ExpressionStatement) {
				if (! _Util$0$exprHasSideEffects$LExpression$((function (o) { return o instanceof ExpressionStatement ? o : null; })(statement).getExpr$())) {
					statements.splice(i, 1);
				}
			}
...
_DeadCodeEliminationOptimizeCommand.prototype._delayAssignmentsBetweenLocals$LMemberFunctionDefinition$ALExpression$ = function (funcDef, exprs) {
	var $this = this;
	/** @type {$TEMPLATECLASS$175} */
	var localsUntouchable;
	/** @type {$TEMPLATECLASS$177} */
	var locals;
	/** @type {*} */
	var _onExpr;
	/** @type {*} */
	var onExpr;
	localsUntouchable = new $TEMPLATECLASS$175$();
	locals = new $TEMPLATECLASS$177$();
...
_DeadCodeEliminationOptimizeCommand.prototype._eliminateDeadStores$LMemberFunctionDefinition$ALExpression$ = function (funcDef, exprs) {
	var $this = this;
	/** @type {Array.<undefined|$TEMPLATECLASS$179>} */
	var lastAssignExpr;
	/** @type {*} */
	var onExpr;
	lastAssignExpr = [];
	onExpr = (function (expr, rewriteCb) {
		...
		if (expr instanceof AssignmentExpression) {
			if ((function (o) { return o instanceof AssignmentExpression ? o : null; })(expr).getToken$().getValue$() === "=" && (function (o) { return o instanceof AssignmentExpression ? o : null; })(expr).getFirstExpr$() instanceof LocalExpression) {
				...
				lastAssignExpr[i] = new $TEMPLATECLASS$179$LLocalVariable$LAssignmentExpression$F$LExpression$V$(lhsLocal, (function (o) { return o instanceof AssignmentExpression ? o : null; })(expr), rewriteCb);
				return true;
			}
		} else {
			if (expr instanceof LocalExpression) {
...
_DeadCodeEliminationOptimizeCommand.prototype._eliminateDeadStoresToProperties$LMemberFunctionDefinition$ALExpression$ = function (funcDef, exprs) {
	...
	/** @type {Object.<string, undefined|$TEMPLATECLASS$180>} */
	var lastAssignExpr;
	/** @type {*} */
	var onExpr;
	...
	onExpr = (function (expr, rewriteCb) {
		...
		if (expr instanceof AssignmentExpression) {
			if (expr.getToken$().getValue$() === "=" && isFirstLevelPropertyAccess((function (o) { return o instanceof AssignmentExpression ? o : null; })(expr).getFirstExpr$()) && ! _Util$0$classIsNative$LClassDefinition$((function (o) { return o instanceof PropertyExpression ? o : null; })((function (o) { return o instanceof AssignmentExpression ? o : null; })(expr).getFirstExpr$()).getExpr$().getType$().getClassDef$())) {
				...
				lastAssignExpr[propertyName] = new $TEMPLATECLASS$180$LAssignmentExpression$F$LExpression$V$((function (o) { return o instanceof AssignmentExpression ? o : null; })(expr), rewriteCb);
				return true;
			} else {
				if ((function (o) { return o instanceof AssignmentExpression ? o : null; })(expr).getFirstExpr$() instanceof LocalExpression) {
					onExpr((function (o) { return o instanceof AssignmentExpression ? o : null; })(expr).getSecondExpr$(), null);
...
_InlineOptimizeCommand.prototype._handleStatement$LMemberFunctionDefinition$ALStatement$N = function (funcDef, statements, stmtIndex) {
	...
	statement.forEachExpression$F$LExpression$F$LExpression$V$B$(onExpr = (function (expr, replaceCb) {
		...
		if (expr instanceof CallExpression) {
			...
			if (args != null) {
				callingFuncDef = _DetermineCalleeCommand$getCallingFuncDef$LStashable$(expr);
				$this.log$S("expanding " + _Util$0$getFuncName$LMemberFunctionDefinition$(callingFuncDef) + " as expression");
	...
	if ((function (o) { return o instanceof _InlineOptimizeCommandStash ? o : null; })(this.getStash$LStashable$(funcDef)).isInlineable == null) {
		(function (o) { return o instanceof _InlineOptimizeCommandStash ? o : null; })(this.getStash$LStashable$(funcDef)).isInlineable = (function () {
			...
			if (requestsInline) {
				...
				if (_Util$0$numberOfStatements$ALStatement$(statements) >= 5) {
					return false;
				}
			}
			return funcDef.forEachStatement$F$LStatement$B$(onStatement = (function (statement) {
		...
		this.log$S(_Util$0$getFuncName$LMemberFunctionDefinition$(funcDef) + ((function (o) { return o instanceof _InlineOptimizeCommandStash ? o : null; })(this.getStash$LStashable$(funcDef)).isInlineable ? " is" : " is not") + " inlineable");
	}
	return (function (v) {
		if (! (v != null)) {
			debugger;
...
_InlineOptimizeCommand.prototype._expandCallingFunction$LMemberFunctionDefinition$ALStatement$NLMemberFunctionDefinition$ALExpression$ = function (callerFuncDef, statements, stmtIndex, calleeFuncDef, argsAndThis) {
	...
	/** @type {*} */
	var onStatement;
	this.log$S("expanding " + _Util$0$getFuncName$LMemberFunctionDefinition$(calleeFuncDef));
...
_ReturnIfOptimizeCommand.prototype.optimizeFunction$LMemberFunctionDefinition$ = function (funcDef) {
	...
	this._altered = false;
	this._optimizeStatements$ALStatement$(funcDef.getStatements$());
	this.log$S(_Util$0$getFuncName$LMemberFunctionDefinition$(funcDef) + " " + (this._altered ? "Y" : "N"));
		...
		if (statement instanceof ForStatement) {
			...
			if (arrayLocal != null) {
				if ($this._lengthIsUnmodifiedInExpr$LExpression$((function (o) { return o instanceof ForStatement ? o : null; })(statement).getCondExpr$()) && $this._lengthIsUnmodifiedInExpr$LExpression$((function (o) { return o instanceof ForStatement ? o : null; })(statement).getPostExpr$()) && (function (o) { return o instanceof ForStatement ? o : null; })(statement).forEachStatement$F$LStatement$B$((function (statement) {
					...
					$this.log$S(_Util$0$getFuncName$LMemberFunctionDefinition$(funcDef) + " optimizing .length at line " + ((function (o) { return o instanceof ForStatement ? o : null; })(statement).getToken$().getLineNumber$() + ""));
	...
	return fmt.replace(/%(\d+|%)/g, (function (m) {
		if (m === "%%") {
			...
			return (function (v) {
				if (! (v != null)) {
					debugger;
					throw new Error("[src/util.jsx:82] null access");
				}
				return v;
			}(args[$__jsx_parseInt(m.substring(1)) - 1]));
		}
	}));
};
	...
	while ((backslashAt = src.indexOf("\\", pos)) !== - 1) {
		...
		case "u":
			...
			decoded += String.fromCharCode($__jsx_parseInt((function (v) {
				if (! (v != null)) {
					debugger;
					throw new Error("[src/util.jsx:215] null access");
				}
				return v;
			}(matched[1])), 16));
			pos += 4;
...
function CompileError$LToken$S(token, message) {
	CompileError$LToken$SUS.call(this, token, message, null);
};
 ...
 * @param {Token} token
 * @param {!string} message
 * @param {undefined|!string} varbose
 */
function CompileError$LToken$SUS(token, message, varbose) {
	this._filename = null;
	this._lineNumber = 0;
...
CompileError$LToken$SUS.prototype = new CompileError;
...
function CompileError$SNNS(filename, lineNumber, columnNumber, message) {
	CompileError$SNNSUS.call(this, filename, lineNumber, columnNumber, message, null);
};
 ...
 * @param {undefined|!string} varbose
 */
function CompileError$SNNSUS(filename, lineNumber, columnNumber, message, varbose) {
...
CompileError$SNNSUS.prototype = new CompileError;
...
CompileError.prototype.format$LCompiler$ = function (compiler) {
	...
	if (this._varbose == null) {
		...
		return Util$format$SAS("[%1:%2:%3] %4%5\n%6\n%7\n", [ this._filename, this._lineNumber + "", col + "", this.getPrefix$(), this._message, sourceLine, this._varbose ]);
	}
};
 ...
 * @param {undefined|!string} varbose
 */
function CompileWarning$LToken$SUS(token, message, varbose) {
	CompileError$LToken$SUS.call(this, token, message, varbose);
};

CompileWarning$LToken$SUS.prototype = new CompileWarning;
 ...
 * @param {undefined|!string} varbose
 */
function CompileWarning$SNNSUS(filename, lineNumber, columnNumber, message, varbose) {
	CompileError$SNNSUS.call(this, filename, lineNumber, columnNumber, message, varbose);
};

CompileWarning$SNNSUS.prototype = new CompileWarning;
...
/**
 * class $TEMPLATECLASS$174 extends Object
 * @constructor
 */
function $TEMPLATECLASS$174() {
}

$TEMPLATECLASS$174.prototype = new Object;
/**
 * @constructor
 * @param {ClassDefinition} first
 * @param {!string} second
 */
function $TEMPLATECLASS$174$LClassDefinition$S(first, second) {
	this.first = first;
	this.second = second;
};

$TEMPLATECLASS$174$LClassDefinition$S.prototype = new $TEMPLATECLASS$174;

/**
 * class $TEMPLATECLASS$175 extends Object
 * @constructor
 */
function $TEMPLATECLASS$175() {
}

$TEMPLATECLASS$175.prototype = new Object;
/**
 * @constructor
 */
function $TEMPLATECLASS$175$() {
	var $this = this;
	$TEMPLATECLASS$175$F$LLocalVariable$LLocalVariable$B$.call(this, (function (x, y) {
		return x == y;
	}));
};

$TEMPLATECLASS$175$.prototype = new $TEMPLATECLASS$175;

/**
 * @constructor
 * @param {*} equalsCallback
 */
function $TEMPLATECLASS$175$F$LLocalVariable$LLocalVariable$B$(equalsCallback) {
	this._list = [  ];
	this._equalsCallback = equalsCallback;
};

$TEMPLATECLASS$175$F$LLocalVariable$LLocalVariable$B$.prototype = new $TEMPLATECLASS$175;

/**
 * @param {LocalVariable} key
 * @return {!boolean}
 */
$TEMPLATECLASS$175.prototype.exists$LLocalVariable$ = function (key) {
	var $this = this;
 ...
 * @param {!boolean} val
 */
$TEMPLATECLASS$175.prototype.put$LLocalVariable$B = function (key, val) {
	/** @type {!number} */
	var i;
	...
	this._list.push(new $TEMPLATECLASS$176$LLocalVariable$B(key, val));
};
 ...
 */
$TEMPLATECLASS$175.prototype.get$LLocalVariable$ = function (key) {
	/** @type {!number} */
	var i;
	for (i = 0; i < this._list.length; ++ i) {
		if (this._equalsCallback(this._list[i].first, key)) {
 ...
 * @param {LocalVariable} key
 */
$TEMPLATECLASS$175.prototype.remove$LLocalVariable$ = function (key) {
	/** @type {!number} */
	var i;
	for (i = 0; i < this._list.length; ++ i) {
		if (this._equalsCallback(this._list[i].first, key)) {
...
/**
 */
$TEMPLATECLASS$175.prototype.clear$ = function () {
 ...
 * @return {!boolean}
 */
$TEMPLATECLASS$175.prototype.forEach$F$LLocalVariable$BB$ = function (cb) {
	/** @type {!number} */
	var i;
	/** @type {$TEMPLATECLASS$176} */
	var e;
	for (i = 0; i < this._list.length; ++ i) {
		e = this._list[i];
 ...
 * @return {!boolean}
 */
$TEMPLATECLASS$175.prototype.reversedForEach$F$LLocalVariable$BB$ = function (cb) {
	/** @type {!number} */
	var i;
	/** @type {$TEMPLATECLASS$176} */
	var e;
...
/**
 * class $TEMPLATECLASS$176 extends Object
 * @constructor
 */
function $TEMPLATECLASS$176() {
}

$TEMPLATECLASS$176.prototype = new Object;
/**
 * @constructor
 * @param {LocalVariable} first
 * @param {!boolean} second
 */
function $TEMPLATECLASS$176$LLocalVariable$B(first, second) {
	this.first = first;
	this.second = second;
};

$TEMPLATECLASS$176$LLocalVariable$B.prototype = new $TEMPLATECLASS$176;

/**
 * class $TEMPLATECLASS$177 extends Object
 * @constructor
 */
function $TEMPLATECLASS$177() {
}

$TEMPLATECLASS$177.prototype = new Object;
/**
 * @constructor
 */
function $TEMPLATECLASS$177$() {
	var $this = this;
	$TEMPLATECLASS$177$F$LLocalVariable$LLocalVariable$B$.call(this, (function (x, y) {
		return x == y;
	}));
};

$TEMPLATECLASS$177$.prototype = new $TEMPLATECLASS$177;

/**
 * @constructor
 * @param {*} equalsCallback
 */
function $TEMPLATECLASS$177$F$LLocalVariable$LLocalVariable$B$(equalsCallback) {
	this._list = [  ];
	this._equalsCallback = equalsCallback;
};

$TEMPLATECLASS$177$F$LLocalVariable$LLocalVariable$B$.prototype = new $TEMPLATECLASS$177;

/**
 * @param {LocalVariable} key
 * @return {!boolean}
 */
$TEMPLATECLASS$177.prototype.exists$LLocalVariable$ = function (key) {
	var $this = this;
 ...
 */
$TEMPLATECLASS$177.prototype.put$LLocalVariable$LExpression$ = function (key, val) {
	/** @type {!number} */
	var i;
	for (i = 0; i < this._list.length; ++ i) {
		if (this._equalsCallback(this._list[i].first, key)) {
	...
	this._list.push(new $TEMPLATECLASS$178$LLocalVariable$LExpression$(key, val));
};
 ...
 * @return {Expression}
 */
$TEMPLATECLASS$177.prototype.get$LLocalVariable$ = function (key) {
	/** @type {!number} */
	var i;
	for (i = 0; i < this._list.length; ++ i) {
		if (this._equalsCallback(this._list[i].first, key)) {
 ...
 * @param {LocalVariable} key
 */
$TEMPLATECLASS$177.prototype.remove$LLocalVariable$ = function (key) {
	/** @type {!number} */
	var i;
	for (i = 0; i < this._list.length; ++ i) {
		if (this._equalsCallback(this._list[i].first, key)) {
...
/**
 */
$TEMPLATECLASS$177.prototype.clear$ = function () {
	this._list.splice(0, this._list.length);
};
 ...
 * @return {!boolean}
 */
$TEMPLATECLASS$177.prototype.forEach$F$LLocalVariable$LExpression$B$ = function (cb) {
	/** @type {!number} */
	var i;
	/** @type {$TEMPLATECLASS$178} */
	var e;
	for (i = 0; i < this._list.length; ++ i) {
		e = this._list[i];
		if (! cb(e.first, e.second)) {
 ...
 * @return {!boolean}
 */
$TEMPLATECLASS$177.prototype.reversedForEach$F$LLocalVariable$LExpression$B$ = function (cb) {
	/** @type {!number} */
	var i;
	/** @type {$TEMPLATECLASS$178} */
	var e;
...
/**
 * class $TEMPLATECLASS$178 extends Object
 * @constructor
 */
function $TEMPLATECLASS$178() {
}

$TEMPLATECLASS$178.prototype = new Object;
/**
 * @constructor
 * @param {LocalVariable} first
 * @param {Expression} second
 */
function $TEMPLATECLASS$178$LLocalVariable$LExpression$(first, second) {
	this.first = first;
	this.second = second;
};

$TEMPLATECLASS$178$LLocalVariable$LExpression$.prototype = new $TEMPLATECLASS$178;

/**
 * class $TEMPLATECLASS$179 extends Object
 * @constructor
 */
function $TEMPLATECLASS$179() {
}

$TEMPLATECLASS$179.prototype = new Object;
/**
 * @constructor
 * @param {LocalVariable} first
 ...
 * @param {*} third
 */
function $TEMPLATECLASS$179$LLocalVariable$LAssignmentExpression$F$LExpression$V$(first, second, third) {
	this.first = first;
	this.second = second;
	this.third = third;
};

$TEMPLATECLASS$179$LLocalVariable$LAssignmentExpression$F$LExpression$V$.prototype = new $TEMPLATECLASS$179;

/**
 * class $TEMPLATECLASS$180 extends Object
 * @constructor
 */
function $TEMPLATECLASS$180() {
}

$TEMPLATECLASS$180.prototype = new Object;
/**
 * @constructor
 * @param {AssignmentExpression} first
 * @param {*} second
 */
function $TEMPLATECLASS$180$LAssignmentExpression$F$LExpression$V$(first, second) {
	this.first = first;
	this.second = second;
};

$TEMPLATECLASS$180$LAssignmentExpression$F$LExpression$V$.prototype = new $TEMPLATECLASS$180;

/**
 * class $TEMPLATECLASS$181 extends Object
 * @constructor
 */
function $TEMPLATECLASS$181() {
}

$TEMPLATECLASS$181.prototype = new Object;
/**
 * @constructor
 */
function $TEMPLATECLASS$181$() {
...
$TEMPLATECLASS$181$.prototype = new $TEMPLATECLASS$181;

/**
 * @param {Array.<undefined|Token>} a
 * @return {*}
 */
$TEMPLATECLASS$181.serializeArray$ALToken$ = function (a) {
	/** @type {Array.<undefined|*>} */
	var ret;
	/** @type {!number} */
	var i;
...
var $TEMPLATECLASS$181$serializeArray$ALToken$ = $TEMPLATECLASS$181.serializeArray$ALToken$;

/**
 * @param {Token} v
 * @return {*}
 */
$TEMPLATECLASS$181.serializeNullable$LToken$ = function (v) {
	if (v == null) {
		return null;
	}
	return v.serialize$();
...
var $TEMPLATECLASS$181$serializeNullable$LToken$ = $TEMPLATECLASS$181.serializeNullable$LToken$;

/**
 * class $TEMPLATECLASS$182 extends Object
 * @constructor
 */
function $TEMPLATECLASS$182() {
}

$TEMPLATECLASS$182.prototype = new Object;
/**
 * @constructor
 */
function $TEMPLATECLASS$182$() {
...
$TEMPLATECLASS$182$.prototype = new $TEMPLATECLASS$182;

/**
 * @param {Array.<undefined|Import>} a
 * @return {*}
 */
$TEMPLATECLASS$182.serializeArray$ALImport$ = function (a) {
	/** @type {Array.<undefined|*>} */
	var ret;
	/** @type {!number} */
	var i;
...
var $TEMPLATECLASS$182$serializeArray$ALImport$ = $TEMPLATECLASS$182.serializeArray$ALImport$;

/**
 * @param {Import} v
 * @return {*}
 */
$TEMPLATECLASS$182.serializeNullable$LImport$ = function (v) {
	if (v == null) {
		return null;
	}
	return v.serialize$();
...
var $TEMPLATECLASS$182$serializeNullable$LImport$ = $TEMPLATECLASS$182.serializeNullable$LImport$;

/**
 * class $TEMPLATECLASS$183 extends Object
 * @constructor
 */
function $TEMPLATECLASS$183() {
}

$TEMPLATECLASS$183.prototype = new Object;
/**
 * @constructor
 */
function $TEMPLATECLASS$183$() {
...
$TEMPLATECLASS$183$.prototype = new $TEMPLATECLASS$183;

/**
 * @param {Array.<undefined|ParsedObjectType>} a
 * @return {*}
 */
$TEMPLATECLASS$183.serializeArray$ALParsedObjectType$ = function (a) {
	/** @type {Array.<undefined|*>} */
	var ret;
	/** @type {!number} */
	var i;
...
var $TEMPLATECLASS$183$serializeArray$ALParsedObjectType$ = $TEMPLATECLASS$183.serializeArray$ALParsedObjectType$;

/**
 * @param {ParsedObjectType} v
 * @return {*}
 */
$TEMPLATECLASS$183.serializeNullable$LParsedObjectType$ = function (v) {
	if (v == null) {
		return null;
	}
	return v.serialize$();
...
var $TEMPLATECLASS$183$serializeNullable$LParsedObjectType$ = $TEMPLATECLASS$183.serializeNullable$LParsedObjectType$;

/**
 * class $TEMPLATECLASS$184 extends Object
 * @constructor
 */
function $TEMPLATECLASS$184() {
}

$TEMPLATECLASS$184.prototype = new Object;
/**
 * @constructor
 */
function $TEMPLATECLASS$184$() {
...
$TEMPLATECLASS$184$.prototype = new $TEMPLATECLASS$184;

/**
 * @param {Array.<undefined|MemberDefinition>} a
 * @return {*}
 */
$TEMPLATECLASS$184.serializeArray$ALMemberDefinition$ = function (a) {
	/** @type {Array.<undefined|*>} */
	var ret;
	/** @type {!number} */
	var i;
...
var $TEMPLATECLASS$184$serializeArray$ALMemberDefinition$ = $TEMPLATECLASS$184.serializeArray$ALMemberDefinition$;

/**
 * @param {MemberDefinition} v
 * @return {*}
 */
$TEMPLATECLASS$184.serializeNullable$LMemberDefinition$ = function (v) {
	if (v == null) {
		return null;
	}
	return v.serialize$();
...
var $TEMPLATECLASS$184$serializeNullable$LMemberDefinition$ = $TEMPLATECLASS$184.serializeNullable$LMemberDefinition$;

/**
 * class $TEMPLATECLASS$185 extends Object
 * @constructor
 */
function $TEMPLATECLASS$185() {
}

$TEMPLATECLASS$185.prototype = new Object;
/**
 * @constructor
 */
function $TEMPLATECLASS$185$() {
...
$TEMPLATECLASS$185$.prototype = new $TEMPLATECLASS$185;

/**
 * @param {Array.<undefined|Type>} a
 * @return {*}
 */
$TEMPLATECLASS$185.serializeArray$ALType$ = function (a) {
	/** @type {Array.<undefined|*>} */
	var ret;
	/** @type {!number} */
	var i;
...
var $TEMPLATECLASS$185$serializeArray$ALType$ = $TEMPLATECLASS$185.serializeArray$ALType$;

/**
 * @param {Type} v
 * @return {*}
 */
$TEMPLATECLASS$185.serializeNullable$LType$ = function (v) {
	if (v == null) {
		return null;
	}
	return v.serialize$();
...
var $TEMPLATECLASS$185$serializeNullable$LType$ = $TEMPLATECLASS$185.serializeNullable$LType$;

/**
 * class $TEMPLATECLASS$186 extends Object
 * @constructor
 */
function $TEMPLATECLASS$186() {
}

$TEMPLATECLASS$186.prototype = new Object;
/**
 * @constructor
 */
function $TEMPLATECLASS$186$() {
...
$TEMPLATECLASS$186$.prototype = new $TEMPLATECLASS$186;

/**
 * @param {Array.<undefined|Expression>} a
 * @return {*}
 */
$TEMPLATECLASS$186.serializeArray$ALExpression$ = function (a) {
	/** @type {Array.<undefined|*>} */
	var ret;
	/** @type {!number} */
	var i;
...
var $TEMPLATECLASS$186$serializeArray$ALExpression$ = $TEMPLATECLASS$186.serializeArray$ALExpression$;

/**
 * @param {Expression} v
 * @return {*}
 */
$TEMPLATECLASS$186.serializeNullable$LExpression$ = function (v) {
	if (v == null) {
		return null;
	}
	return v.serialize$();
...
var $TEMPLATECLASS$186$serializeNullable$LExpression$ = $TEMPLATECLASS$186.serializeNullable$LExpression$;

/**
 * class $TEMPLATECLASS$187 extends Object
 * @constructor
 */
function $TEMPLATECLASS$187() {
}

$TEMPLATECLASS$187.prototype = new Object;
/**
 * @constructor
 */
function $TEMPLATECLASS$187$() {
...
$TEMPLATECLASS$187$.prototype = new $TEMPLATECLASS$187;

/**
 * @param {Array.<undefined|ArgumentDeclaration>} a
 * @return {*}
 */
$TEMPLATECLASS$187.serializeArray$ALArgumentDeclaration$ = function (a) {
	/** @type {Array.<undefined|*>} */
	var ret;
	/** @type {!number} */
	var i;
...
var $TEMPLATECLASS$187$serializeArray$ALArgumentDeclaration$ = $TEMPLATECLASS$187.serializeArray$ALArgumentDeclaration$;

/**
 * @param {ArgumentDeclaration} v
 * @return {*}
 */
$TEMPLATECLASS$187.serializeNullable$LArgumentDeclaration$ = function (v) {
	if (v == null) {
		return null;
	}
	return v.serialize$();
...
var $TEMPLATECLASS$187$serializeNullable$LArgumentDeclaration$ = $TEMPLATECLASS$187.serializeNullable$LArgumentDeclaration$;

/**
 * class $TEMPLATECLASS$188 extends Object
 * @constructor
 */
function $TEMPLATECLASS$188() {
}

$TEMPLATECLASS$188.prototype = new Object;
/**
 * @constructor
 */
function $TEMPLATECLASS$188$() {
...
$TEMPLATECLASS$188$.prototype = new $TEMPLATECLASS$188;

/**
 * @param {Array.<undefined|LocalVariable>} a
 * @return {*}
 */
$TEMPLATECLASS$188.serializeArray$ALLocalVariable$ = function (a) {
	/** @type {Array.<undefined|*>} */
	var ret;
	/** @type {!number} */
	var i;
...
var $TEMPLATECLASS$188$serializeArray$ALLocalVariable$ = $TEMPLATECLASS$188.serializeArray$ALLocalVariable$;

/**
 * @param {LocalVariable} v
 * @return {*}
 */
$TEMPLATECLASS$188.serializeNullable$LLocalVariable$ = function (v) {
	if (v == null) {
		return null;
	}
	return v.serialize$();
...
var $TEMPLATECLASS$188$serializeNullable$LLocalVariable$ = $TEMPLATECLASS$188.serializeNullable$LLocalVariable$;

/**
 * class $TEMPLATECLASS$189 extends Object
 * @constructor
 */
function $TEMPLATECLASS$189() {
}

$TEMPLATECLASS$189.prototype = new Object;
/**
 * @constructor
 */
function $TEMPLATECLASS$189$() {
...
$TEMPLATECLASS$189$.prototype = new $TEMPLATECLASS$189;

/**
 * @param {Array.<undefined|Statement>} a
 * @return {*}
 */
$TEMPLATECLASS$189.serializeArray$ALStatement$ = function (a) {
	/** @type {Array.<undefined|*>} */
	var ret;
	/** @type {!number} */
	var i;
...
var $TEMPLATECLASS$189$serializeArray$ALStatement$ = $TEMPLATECLASS$189.serializeArray$ALStatement$;

/**
 * @param {Statement} v
 * @return {*}
 */
$TEMPLATECLASS$189.serializeNullable$LStatement$ = function (v) {
	if (v == null) {
		return null;
	}
	return v.serialize$();
...
var $TEMPLATECLASS$189$serializeNullable$LStatement$ = $TEMPLATECLASS$189.serializeNullable$LStatement$;

/**
 * class $TEMPLATECLASS$190 extends Object
 * @constructor
 */
function $TEMPLATECLASS$190() {
}

$TEMPLATECLASS$190.prototype = new Object;
/**
 * @constructor
 */
function $TEMPLATECLASS$190$() {
	var $this = this;
	$TEMPLATECLASS$190$F$ALType$ALType$B$.call(this, (function (x, y) {
		return x == y;
	}));
};

$TEMPLATECLASS$190$.prototype = new $TEMPLATECLASS$190;

/**
 * @constructor
 * @param {*} equalsCallback
 */
function $TEMPLATECLASS$190$F$ALType$ALType$B$(equalsCallback) {
	this._list = [  ];
	this._equalsCallback = equalsCallback;
};

$TEMPLATECLASS$190$F$ALType$ALType$B$.prototype = new $TEMPLATECLASS$190;

/**
 * @param {Array.<undefined|Type>} key
 * @return {!boolean}
 */
$TEMPLATECLASS$190.prototype.exists$ALType$ = function (key) {
	var $this = this;
 ...
 */
$TEMPLATECLASS$190.prototype.put$ALType$LMemberFunctionDefinition$ = function (key, val) {
	/** @type {!number} */
	var i;
	for (i = 0; i < this._list.length; ++ i) {
		if (this._equalsCallback(this._list[i].first, key)) {
	...
	this._list.push(new $TEMPLATECLASS$191$ALType$LMemberFunctionDefinition$(key, val));
};
 ...
 * @return {MemberFunctionDefinition}
 */
$TEMPLATECLASS$190.prototype.get$ALType$ = function (key) {
	/** @type {!number} */
	var i;
	for (i = 0; i < this._list.length; ++ i) {
		if (this._equalsCallback(this._list[i].first, key)) {
 ...
 * @param {Array.<undefined|Type>} key
 */
$TEMPLATECLASS$190.prototype.remove$ALType$ = function (key) {
	/** @type {!number} */
	var i;
	for (i = 0; i < this._list.length; ++ i) {
		if (this._equalsCallback(this._list[i].first, key)) {
...
/**
 */
$TEMPLATECLASS$190.prototype.clear$ = function () {
	this._list.splice(0, this._list.length);
};
 ...
 * @return {!boolean}
 */
$TEMPLATECLASS$190.prototype.forEach$F$ALType$LMemberFunctionDefinition$B$ = function (cb) {
	/** @type {!number} */
	var i;
	/** @type {$TEMPLATECLASS$191} */
	var e;
	for (i = 0; i < this._list.length; ++ i) {
		e = this._list[i];
		if (! cb(e.first, e.second)) {
 ...
 * @return {!boolean}
 */
$TEMPLATECLASS$190.prototype.reversedForEach$F$ALType$LMemberFunctionDefinition$B$ = function (cb) {
	/** @type {!number} */
	var i;
	/** @type {$TEMPLATECLASS$191} */
	var e;
...
/**
 * class $TEMPLATECLASS$191 extends Object
 * @constructor
 */
function $TEMPLATECLASS$191() {
}

$TEMPLATECLASS$191.prototype = new Object;
/**
 * @constructor
 * @param {Array.<undefined|Type>} first
 * @param {MemberFunctionDefinition} second
 */
function $TEMPLATECLASS$191$ALType$LMemberFunctionDefinition$(first, second) {
	this.first = first;
	this.second = second;
};

$TEMPLATECLASS$191$ALType$LMemberFunctionDefinition$.prototype = new $TEMPLATECLASS$191;

/**
 * class $TEMPLATECLASS$192 extends Object
 * @constructor
 */
function $TEMPLATECLASS$192() {
}

$TEMPLATECLASS$192.prototype = new Object;
/**
 * @constructor
 */
function $TEMPLATECLASS$192$() {
...
$TEMPLATECLASS$192$.prototype = new $TEMPLATECLASS$192;

/**
 * @param {Array.<undefined|Expression>} a
 * @return {Array.<undefined|Expression>}
 */
$TEMPLATECLASS$192.cloneArray$ALExpression$ = function (a) {
	/** @type {Array.<undefined|Expression>} */
	var r;
	/** @type {!number} */
	var i;
...
var $TEMPLATECLASS$192$cloneArray$ALExpression$ = $TEMPLATECLASS$192.cloneArray$ALExpression$;

/**
 * @param {Expression} o
 * @return {Expression}
 */
$TEMPLATECLASS$192.cloneNullable$LExpression$ = function (o) {
	return (o == null ? null : o.clone$());
};

var $TEMPLATECLASS$192$cloneNullable$LExpression$ = $TEMPLATECLASS$192.cloneNullable$LExpression$;

/**
 * class $TEMPLATECLASS$193 extends Object
 * @constructor
 */
function $TEMPLATECLASS$193() {
}

$TEMPLATECLASS$193.prototype = new Object;
/**
 * @constructor
 */
function $TEMPLATECLASS$193$() {
...
$TEMPLATECLASS$193$.prototype = new $TEMPLATECLASS$193;

/**
 * @param {Array.<undefined|MapLiteralElement>} a
 * @return {*}
 */
$TEMPLATECLASS$193.serializeArray$ALMapLiteralElement$ = function (a) {
	/** @type {Array.<undefined|*>} */
	var ret;
	/** @type {!number} */
	var i;
...
var $TEMPLATECLASS$193$serializeArray$ALMapLiteralElement$ = $TEMPLATECLASS$193.serializeArray$ALMapLiteralElement$;

/**
 * @param {MapLiteralElement} v
 * @return {*}
 */
$TEMPLATECLASS$193.serializeNullable$LMapLiteralElement$ = function (v) {
	if (v == null) {
		return null;
	}
	return v.serialize$();
...
var $TEMPLATECLASS$193$serializeNullable$LMapLiteralElement$ = $TEMPLATECLASS$193.serializeNullable$LMapLiteralElement$;

/**
 * class $TEMPLATECLASS$194 extends Object
 * @constructor
 */
function $TEMPLATECLASS$194() {
}

$TEMPLATECLASS$194.prototype = new Object;
/**
 * @constructor
 */
function $TEMPLATECLASS$194$() {
...
$TEMPLATECLASS$194$.prototype = new $TEMPLATECLASS$194;

/**
 * @param {Array.<undefined|ClassDefinition>} a
 * @return {*}
 */
$TEMPLATECLASS$194.serializeArray$ALClassDefinition$ = function (a) {
	/** @type {Array.<undefined|*>} */
	var ret;
	/** @type {!number} */
	var i;
...
var $TEMPLATECLASS$194$serializeArray$ALClassDefinition$ = $TEMPLATECLASS$194.serializeArray$ALClassDefinition$;

/**
 * @param {ClassDefinition} v
 * @return {*}
 */
$TEMPLATECLASS$194.serializeNullable$LClassDefinition$ = function (v) {
	if (v == null) {
		return null;
	}
	return v.serialize$();
...
var $TEMPLATECLASS$194$serializeNullable$LClassDefinition$ = $TEMPLATECLASS$194.serializeNullable$LClassDefinition$;

/**
 * class $TEMPLATECLASS$195 extends Object
 * @constructor
 */
function $TEMPLATECLASS$195() {
}

$TEMPLATECLASS$195.prototype = new Object;
/**
 * @constructor
 */
function $TEMPLATECLASS$195$() {
...
$TEMPLATECLASS$195$.prototype = new $TEMPLATECLASS$195;

/**
 * @param {Array.<undefined|Statement>} a
 * @return {Array.<undefined|Statement>}
 */
$TEMPLATECLASS$195.cloneArray$ALStatement$ = function (a) {
	/** @type {Array.<undefined|Statement>} */
	var r;
	/** @type {!number} */
	var i;
...
var $TEMPLATECLASS$195$cloneArray$ALStatement$ = $TEMPLATECLASS$195.cloneArray$ALStatement$;

/**
 * @param {Statement} o
 * @return {Statement}
 */
$TEMPLATECLASS$195.cloneNullable$LStatement$ = function (o) {
	return (o == null ? null : o.clone$());
};

var $TEMPLATECLASS$195$cloneNullable$LStatement$ = $TEMPLATECLASS$195.cloneNullable$LStatement$;

/**
 * class $TEMPLATECLASS$196 extends Object
 * @constructor
 */
function $TEMPLATECLASS$196() {
}

$TEMPLATECLASS$196.prototype = new Object;
/**
 * @constructor
 */
function $TEMPLATECLASS$196$() {
...
$TEMPLATECLASS$196$.prototype = new $TEMPLATECLASS$196;

/**
 * @param {Array.<undefined|CatchStatement>} a
 * @return {Array.<undefined|CatchStatement>}
 */
$TEMPLATECLASS$196.cloneArray$ALCatchStatement$ = function (a) {
	/** @type {Array.<undefined|CatchStatement>} */
	var r;
	/** @type {!number} */
	var i;
...
var $TEMPLATECLASS$196$cloneArray$ALCatchStatement$ = $TEMPLATECLASS$196.cloneArray$ALCatchStatement$;

/**
 * @param {CatchStatement} o
 * @return {CatchStatement}
 */
$TEMPLATECLASS$196.cloneNullable$LCatchStatement$ = function (o) {
	return (o == null ? null : (function (o) { return o instanceof CatchStatement ? o : null; })(o.clone$()));
};

var $TEMPLATECLASS$196$cloneNullable$LCatchStatement$ = $TEMPLATECLASS$196.cloneNullable$LCatchStatement$;

/**
 * class $TEMPLATECLASS$197 extends Object
 * @constructor
 */
function $TEMPLATECLASS$197() {
}

$TEMPLATECLASS$197.prototype = new Object;
/**
 * @constructor
 */
function $TEMPLATECLASS$197$() {
...
$TEMPLATECLASS$197$.prototype = new $TEMPLATECLASS$197;

/**
 * @param {Array.<undefined|CatchStatement>} a
 * @return {*}
 */
$TEMPLATECLASS$197.serializeArray$ALCatchStatement$ = function (a) {
	/** @type {Array.<undefined|*>} */
	var ret;
	/** @type {!number} */
	var i;
...
var $TEMPLATECLASS$197$serializeArray$ALCatchStatement$ = $TEMPLATECLASS$197.serializeArray$ALCatchStatement$;

/**
 * @param {CatchStatement} v
 * @return {*}
 */
$TEMPLATECLASS$197.serializeNullable$LCatchStatement$ = function (v) {
	if (v == null) {
		return null;
	}
	return v.serialize$();
...
var $TEMPLATECLASS$197$serializeNullable$LCatchStatement$ = $TEMPLATECLASS$197.serializeNullable$LCatchStatement$;
...
_Main$0.main$AS = function (args) {
	...
	eval = (function (o) { return typeof(o) === "function" ? o : null; })(js.global.eval);
	node.fs = eval('require("fs")');
	console.log(node.fs.readFileSync('hoge.js'));
};
...
Import.prototype.serialize$ = function () {
	return [ "Import", $TEMPLATECLASS$181$serializeNullable$LToken$(this._filenameToken), $TEMPLATECLASS$181$serializeNullable$LToken$(this._aliasToken), $TEMPLATECLASS$181$serializeArray$ALToken$(this._classNames) ];
};
...
QualifiedName.prototype.serialize$ = function () {
	return [ "QualifiedName", this._token.serialize$(), $TEMPLATECLASS$182$serializeNullable$LImport$(this._import) ];
};
...
ClassDefinition.prototype.serialize$ = function () {
	return { "token": this._token, "name": this._className, "flags": this._flags, "extends": $TEMPLATECLASS$183$serializeNullable$LParsedObjectType$(this._extendType), "implements": $TEMPLATECLASS$183$serializeArray$ALParsedObjectType$(this._implementTypes), "members": $TEMPLATECLASS$184$serializeArray$ALMemberDefinition$(this._members) };
};
...
MemberVariableDefinition.prototype.serialize$ = function () {
	return { "token": this._token.serialize$(), "nameToken": $TEMPLATECLASS$181$serializeNullable$LToken$(this._nameToken), "flags": this.flags$(), "type": $TEMPLATECLASS$185$serializeNullable$LType$(this._type), "initialValue": $TEMPLATECLASS$186$serializeNullable$LExpression$(this._initialValue) };
};
...
MemberFunctionDefinition.prototype.serialize$ = function () {
	return { "token": this._token.serialize$(), "nameToken": $TEMPLATECLASS$181$serializeNullable$LToken$(this._nameToken), "flags": this.flags$(), "returnType": $TEMPLATECLASS$185$serializeNullable$LType$(this._returnType), "args": $TEMPLATECLASS$187$serializeArray$ALArgumentDeclaration$(this._args), "locals": $TEMPLATECLASS$188$serializeArray$ALLocalVariable$(this._locals), "statements": $TEMPLATECLASS$189$serializeArray$ALStatement$(this._statements) };
};
...
function TemplateFunctionDefinition$LToken$LToken$NALToken$LType$ALArgumentDeclaration$ALLocalVariable$ALStatement$ALMemberFunctionDefinition$LToken$LDocComment$(token, name, flags, typeArgs, returnType, args, locals, statements, closures, lastTokenOfBody, docComment) {
	...
	this._instantiatedDefs = new $TEMPLATECLASS$190$F$ALType$ALType$B$((function (x, y) {
		/** @type {!number} */
		var i;
		for (i = 0; i < x.length; ++ i) {
			if (! x[i].equals$LType$(y[i])) {
...
LocalVariable.prototype.serialize$ = function () {
	return [ this._name, $TEMPLATECLASS$185$serializeNullable$LType$(this._type) ];
};
...
ArrayLiteralExpression.prototype.clone$ = function () {
	return new ArrayLiteralExpression$LToken$ALExpression$LType$(this._token, $TEMPLATECLASS$192$cloneArray$ALExpression$(this._exprs), this._type);
};
...
ArrayLiteralExpression.prototype.serialize$ = function () {
	return [ "ArrayLiteralExpression", this._token.serialize$(), $TEMPLATECLASS$186$serializeArray$ALExpression$(this._exprs), $TEMPLATECLASS$185$serializeNullable$LType$(this._type) ];
};
...
MapLiteralExpression.prototype.serialize$ = function () {
	return [ "MapLiteralExpression", this._token.serialize$(), $TEMPLATECLASS$193$serializeArray$ALMapLiteralElement$(this._elements), $TEMPLATECLASS$185$serializeNullable$LType$(this._type) ];
};
...
ThisExpression.prototype.serialize$ = function () {
	return [ "ThisExpression", this._token.serialize$(), $TEMPLATECLASS$194$serializeNullable$LClassDefinition$(this._classDef) ];
};
...
PropertyExpression.prototype.serialize$ = function () {
	return [ "PropertyExpression", this._expr.serialize$(), this._identifierToken.serialize$(), $TEMPLATECLASS$185$serializeNullable$LType$(this._type) ];
};
...
ConditionalExpression.prototype.serialize$ = function () {
	return [ "ConditionalExpression", this._token.serialize$(), this._condExpr.serialize$(), $TEMPLATECLASS$186$serializeNullable$LExpression$(this._ifTrueExpr), this._ifFalseExpr.serialize$() ];
};
...
function CallExpression$LCallExpression$(that) {
	...
	this._args = $TEMPLATECLASS$192$cloneArray$ALExpression$(that._args);
};
...
CallExpression.prototype.serialize$ = function () {
	return [ "CallExpression", this._token.serialize$(), this._expr.serialize$(), $TEMPLATECLASS$186$serializeArray$ALExpression$(this._args) ];
};
...
SuperExpression.prototype.serialize$ = function () {
	return [ "SuperExpression", this._token.serialize$(), this._name.serialize$(), $TEMPLATECLASS$186$serializeArray$ALExpression$(this._args), $TEMPLATECLASS$194$serializeNullable$LClassDefinition$(this._classDef) ];
};
...
NewExpression.prototype.serialize$ = function () {
	return [ "NewExpression", this._token.serialize$(), this._type.serialize$(), $TEMPLATECLASS$186$serializeArray$ALExpression$(this._args) ];
};
...
NewExpression.prototype.analyze$LAnalysisContext$LExpression$ = function (context, parentExpr) {
	...
	if ((this._constructor = ctors.deduceByArgumentTypes$LAnalysisContext$LToken$ALType$B(context, this._token, argTypes, false)) == null) {
		varbose = 'candidate constructors:\n';
		if (ctors instanceof FunctionChoiceType) {
			varbose += (function (o) { return o instanceof FunctionChoiceType ? o : null; })(ctors)._types.map((function (t) {
				return '  ' + t.toString();
			})).join('\n');
		} else {
			varbose += '  ' + ctors.toString();
		}
		varbose += '\nbut you requested: \n  ' + new MemberFunctionType$LType$LType$ALType$B(this._type, Type.voidType, argTypes, false).toString();
		context.errors.push(new CompileError$LToken$SUS(this._token, "cannot create an object of type '" + this._type.toString() + "', arguments mismatch", varbose));
		return false;
	}
	return true;
};
...
ConstructorInvocationStatement.prototype.clone$ = function () {
	return new ConstructorInvocationStatement$LToken$LType$ALExpression$LFunctionType$(this._token, this._ctorClassType, $TEMPLATECLASS$192$cloneArray$ALExpression$(this._args), this._ctorFunctionType);
};
...
ConstructorInvocationStatement.prototype.instantiate$LInstantiationContext$ = function (instantiationContext) {
	...
	return new ConstructorInvocationStatement$LToken$LType$ALExpression$LFunctionType$(this._token, this._ctorClassType.instantiate$LInstantiationContext$(instantiationContext), $TEMPLATECLASS$192$cloneArray$ALExpression$(this._args), null);
};
...
ConstructorInvocationStatement.prototype.serialize$ = function () {
	return [ "ConstructorInvocationStatement", this._ctorClassType.serialize$(), $TEMPLATECLASS$186$serializeArray$ALExpression$(this._args) ];
};
...
ReturnStatement.prototype.clone$ = function () {
	return new ReturnStatement$LToken$LExpression$(this._token, $TEMPLATECLASS$192$cloneNullable$LExpression$(this._expr));
};
...
ReturnStatement.prototype.serialize$ = function () {
	return [ "ReturnStatement", $TEMPLATECLASS$186$serializeNullable$LExpression$(this._expr) ];
};
...
JumpStatement.prototype.serialize$ = function () {
	return [ this._getName$(), this._token.serialize$(), $TEMPLATECLASS$181$serializeNullable$LToken$(this._label) ];
};
...
LabellableStatement.prototype._serialize$ = function () {
	return [ $TEMPLATECLASS$181$serializeNullable$LToken$(this._label) ];
};
...
DoWhileStatement.prototype.clone$ = function () {
	return new DoWhileStatement$LToken$LToken$LExpression$ALStatement$(this._token, this._label, this._expr.clone$(), $TEMPLATECLASS$195$cloneArray$ALStatement$(this._statements));
};
...
DoWhileStatement.prototype.serialize$ = function () {
	return [ "DoWhileStatement" ].concat(this._serialize$()).concat([ this._expr.serialize$(), $TEMPLATECLASS$189$serializeArray$ALStatement$(this._statements) ]);
};
...
ForInStatement.prototype.clone$ = function () {
	return new ForInStatement$LToken$LToken$LExpression$LExpression$ALStatement$(this._token, this._label, this._lhsExpr.clone$(), this._listExpr.clone$(), $TEMPLATECLASS$195$cloneArray$ALStatement$(this._statements));
};
...
ForInStatement.prototype.serialize$ = function () {
	return [ "ForInStatement" ].concat(this._serialize$()).concat([ this._lhsExpr.serialize$(), this._listExpr.serialize$(), $TEMPLATECLASS$189$serializeArray$ALStatement$(this._statements) ]);
};
...
ForStatement.prototype.clone$ = function () {
	return new ForStatement$LToken$LToken$LExpression$LExpression$LExpression$ALStatement$(this._token, this._label, $TEMPLATECLASS$192$cloneNullable$LExpression$(this._initExpr), $TEMPLATECLASS$192$cloneNullable$LExpression$(this._condExpr), $TEMPLATECLASS$192$cloneNullable$LExpression$(this._postExpr), $TEMPLATECLASS$195$cloneArray$ALStatement$(this._statements));
};
...
ForStatement.prototype.serialize$ = function () {
	return [ "ForStatement" ].concat(this._serialize$()).concat([ $TEMPLATECLASS$186$serializeNullable$LExpression$(this._initExpr), $TEMPLATECLASS$186$serializeNullable$LExpression$(this._condExpr), $TEMPLATECLASS$186$serializeNullable$LExpression$(this._postExpr), $TEMPLATECLASS$189$serializeArray$ALStatement$(this._statements) ]);
};
...
IfStatement.prototype.clone$ = function () {
	return new IfStatement$LToken$LExpression$ALStatement$ALStatement$(this._token, this._expr.clone$(), $TEMPLATECLASS$195$cloneArray$ALStatement$(this._onTrueStatements), $TEMPLATECLASS$195$cloneArray$ALStatement$(this._onFalseStatements));
};
...
IfStatement.prototype.serialize$ = function () {
	return [ "IfStatement", this._expr.serialize$(), $TEMPLATECLASS$189$serializeArray$ALStatement$(this._onTrueStatements), $TEMPLATECLASS$189$serializeArray$ALStatement$(this._onFalseStatements) ];
};
...
SwitchStatement.prototype.clone$ = function () {
	return new SwitchStatement$LToken$LToken$LExpression$ALStatement$(this._token, this._label, this._expr.clone$(), $TEMPLATECLASS$195$cloneArray$ALStatement$(this._statements));
};
...
SwitchStatement.prototype.serialize$ = function () {
	return [ "SwitchStatement" ].concat(this._serialize$()).concat([ this._expr.serialize$(), $TEMPLATECLASS$189$serializeArray$ALStatement$(this._statements) ]);
};
...
WhileStatement.prototype.clone$ = function () {
	return new WhileStatement$LToken$LToken$LExpression$ALStatement$(this._token, this._label, this._expr.clone$(), $TEMPLATECLASS$195$cloneArray$ALStatement$(this._statements));
};
...
WhileStatement.prototype.serialize$ = function () {
	return [ "WhileStatement" ].concat(this._serialize$()).concat([ this._expr.serialize$(), $TEMPLATECLASS$189$serializeArray$ALStatement$(this._statements) ]);
};
...
TryStatement.prototype.clone$ = function () {
	return new TryStatement$LToken$ALStatement$ALCatchStatement$ALStatement$(this._token, $TEMPLATECLASS$195$cloneArray$ALStatement$(this._tryStatements), $TEMPLATECLASS$196$cloneArray$ALCatchStatement$(this._catchStatements), $TEMPLATECLASS$195$cloneArray$ALStatement$(this._finallyStatements));
};
...
TryStatement.prototype.serialize$ = function () {
	return [ "TryStatement", $TEMPLATECLASS$189$serializeArray$ALStatement$(this._tryStatements), $TEMPLATECLASS$197$serializeArray$ALCatchStatement$(this._catchStatements), $TEMPLATECLASS$189$serializeArray$ALStatement$(this._finallyStatements) ];
};
...
CatchStatement.prototype.clone$ = function () {
	return new CatchStatement$LToken$LCaughtVariable$ALStatement$(this._token, this._local.clone$(), $TEMPLATECLASS$195$cloneArray$ALStatement$(this._statements));
};
...
CatchStatement.prototype.serialize$ = function () {
	return [ "CatchStatement", this._token.serialize$(), this._local.serialize$(), $TEMPLATECLASS$189$serializeArray$ALStatement$(this._statements) ];
};
...
AssertStatement.prototype.serialize$ = function () {
	return [ "AssertStatement", this._token.serialize$(), $TEMPLATECLASS$186$serializeNullable$LExpression$(this._expr) ];
};
...
LogStatement.prototype.clone$ = function () {
	return new LogStatement$LToken$ALExpression$(this._token, $TEMPLATECLASS$192$cloneArray$ALExpression$(this._exprs));
};
...
LogStatement.prototype.serialize$ = function () {
	return [ "LogStatement", this._token.serialize$(), $TEMPLATECLASS$186$serializeArray$ALExpression$(this._exprs) ];
};
...
var $__jsx_classMap = {
	...
	"src/util.jsx": {
		...
		CompileError$LToken$SUS: CompileError$LToken$SUS,
		CompileError$SNNS: CompileError$SNNS,
		CompileError$SNNSUS: CompileError$SNNSUS,
		CompileWarning: CompileWarning,
		CompileWarning$LToken$S: CompileWarning$LToken$S,
		CompileWarning$LToken$SUS: CompileWarning$LToken$SUS,
		CompileWarning$SNNS: CompileWarning$SNNS,
		CompileWarning$SNNSUS: CompileWarning$SNNSUS,
