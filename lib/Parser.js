...
var DoWhileStatement = require("./DoWhileStatement");
...
var Parser = module.exports = Class.extend({
	...
	_variableStatement: function () {
		var exprs = this._variableDeclarations();
		if (exprs == null)
			return false;
		if (this._expectKeyword(";") == null)
			return false;
	...
	_forStatement: function () {
		...
		if (this._expectKeywordOpt(";") != null) {
			...
			if ((initExpr = this._expr(false)) == null)
				return false;
			if (this._expectKeyword(";") == null)
				return false;
		}
	...
	_variableDeclarations: function () {
		var vars = [];
		do {
			...
			if (initialValue != null)
				vars.push(new AssignmentExpression(new IdentifierExpression(identifier), initialValue));
		} while (this._expectKeywordOpt(",") != null);
		return vars;
	},
	...
	_lorExpr: function (noIn) {
		return this._binaryOpExpr([ "||" ], this._landExpr, noIn, function (_unused, e1, e2) {
			return new LogicalExpression("||", e1, e2);
		});
	},

	_landExpr: function (noIn) {
		return this._binaryOpExpr([ "&&" ], this._borExpr, noIn, function (_unused, e1, e2) {
			return new LogicalExpression("&&", e1, e2);
		});
	},

	_borExpr: function (noIn) {
		return this._binaryOpExpr([ "|" ], this._bxorExpr, noIn, function (_unused, e1, e2) {
			return new BitwiseExpression("|", e1, e2);
		});
	},

	_bxorExpr: function (noIn) {
		return this._binaryOpExpr([ "^" ], this._bandExpr, noIn, function (_unused, e1, e2) {
			return new BitwiseExpression("^", e1, e2);
		});
	},

	_bandExpr: function (noIn) {
		return this._binaryOpExpr([ "&" ], this._eqExpr, noIn, function (_unused, e1, e2) {
			return new BitwiseExpression("&", e1, e2);
		});
	},
