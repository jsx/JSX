...
var Parser = exports.Parser = Class.extend({
	...
	_classDefinition: function () {
		...
		// done
		if (typeArgs != null)
			this._templateClassDefs.push(new TemplateClassDefinition(className, flags, typeArgs, extendName, implementNames, members, this._objectTypesUsed));
		else
			this._classDefs.push(new ClassDefinition(className, flags, extendName, implementNames, members, this._objectTypesUsed));
		return true;
	},
