...
var Parser = exports.Parser = Class.extend({
	...
	_classDefinition: function () {
		...
		// attributes
		var flags = 0;
		if (this._expectOpt("final") != null) {
			flags |= ClassDefinition.IS_FINAL;
		}
		// class
		if (this._expect("class") == null) {
			return null;
		}
	...
	_memberDefinition: function () {
		...
		while (true) {
			var newFlag = 0;
			if (this._expectOpt("static") != null)
				newFlag = ClassDefinition.IS_STATIC;
			else if (this._expectOpt("abstract") != null)
				newFlag = ClassDefinition.IS_ABSTRACT;
			else if (this._expectOpt("final") != null)
				newFlag = ClassDefinition.IS_FINAL;
			else if (this._expectOpt("const") != null)
		...
		var functionOrVar = this._expect([ "function", "var" ]);
	...
	_functionDefinition: function (flags) {
		...
		if ((flags & ClassDefinition.IS_ABSTRACT) != 0) {
			if (this._expect(";", "function body should not exist for an abstract function") == null)
				return null;
