...
var IdentifierExpression = exports.IdentifierExpression = Expression.extend({
	...
	analyze: function (errors, classDefs, funcDef) {
		// FIXME identifier + propertyExpression should be converted to ClassReferenceExpression before analyze
...
var PropertyExpression = exports.PropertyExpression = UnaryExpression.extend({
	...
	analyze: function (errors, classDefs, funcDef) {
		...
		if ((this._type = classDef.getMemberTypesByName(errors, classDefs, this._identifierToken.identifier)) == null) {
...
var ConditionalExpression = exports.ConditionalExpression = OperatorExpression.extend({
	...
	analyze: function (errors, classDefs, funcDef) {
		...
		if (! typeIfTrue.equals(typeIfFalse)) {
			errors.push(new CompileError(this._operatorToken, "returned types should be the same for operator ?:"));
			return false;
		}
		return true;
	},
