...
var _ForStatementEmitter = exports._ForStatementEmitter = _StatementEmitter.extend({
	...
	emit: function () {
		...
		if (initExpr != null)
			this._emitter._getExpressionEmitterFor(initExpr).emit();
		this._emitter._emit("; ", null);
		var condExpr = this._statement.getCondExpr();
		if (condExpr != null)
			this._emitter._getExpressionEmitterFor(condExpr).emit();
		this._emitter._emit("; ", null);
		var postExpr = this._statement.getPostExpr();
		debugger;
		if (postExpr != null)
			this._emitter._getExpressionEmitterFor(postExpr).emit();
		this._emitter._emit(") {\n", null);
