...
var ClassDefinition = exports.ClassDefinition = Class.extend({
	...
	analyze: function (context) {
		...
		for (var i = 0; i < this._members.length; ++i)
			this._assertMemberIsDefinable(context, this._members[i], this, this._members[i]);
	...
	_assertMemberVariableIsDefinable: function (context, member, memberClassDef, token) {
		for (var i = 0; i < this._members.length; ++i) {
			if (this._members[i].name() == member.name() && (this._members[i].flags() & ClassDefinition.IS_ABSTRACT) == 0) {
