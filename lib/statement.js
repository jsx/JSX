...
var ConstructorInvocationStatement = exports.ConstructorInvocationStatement = Statement.extend({
	...
	analyze: function (context) {
		...
		if (className == "super") {
			...
			if ((this._ctorClassDef = ClassDefinition.getClass(context.classDefs, className)) == null) {
		...
		var ctorType = this._ctorClassDef.getMemberTypeByName(context.errors, context.classDefs, "initialize", false);
		if (ctorType == null) {
