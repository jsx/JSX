...
var IdentifierToken = exports.IdentifierToken = Token.extend({
	...
	serialize: function () {
		return this._serialize("identifier", this._value);
	},
...
var KeywordToken = exports.KeywordToken = Token.extend({
	...
	serialize: function () {
		return this._serialize("keyword", this._value);
	},
...
var RegExpToken = exports.RegExpToken = Token.extend({
	...
	serialize: function () {
		return this._serialize("RegExp", this._source);
	}
});
...
var StringToken = exports.StringToken = Token.extend({
	...
	initialize: function (source, filename, pos) {
		...
		this._source = source;
		this._value = source.substring(1, source.length - 1).replace(/\\(.)/g, "$1");
	},
	...
	serialize: function () {
		return this._serialize("string", this._value);
	}
